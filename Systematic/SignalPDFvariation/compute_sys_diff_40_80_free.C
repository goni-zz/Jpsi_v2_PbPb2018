...
void compute_sys_diff_20_120_free()
{
  ...
  for(int ib=0; ib<nPtBinNP; ib++){
    ...
    if(ib==0) fileAltNP = dirAlt+Form("SignalPDFvariation_v2_pt%.1f-%.1f_y1.6-2.4_muPt0.0_centrality20-120.root",PtBinArrNP[ib],PtBinArrNP[ib+1]);
    else if(ib==1) fileAltNP = dirAlt+Form("SignalPDFvariation_v2_pt%.1f-%.1f_y1.6-2.4_muPt0.0_centrality20-120_free.root",PtBinArrNP[ib],PtBinArrNP[ib+1]);
