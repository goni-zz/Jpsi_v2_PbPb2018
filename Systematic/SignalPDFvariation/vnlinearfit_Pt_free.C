...
void vnlinearfit_Pt_free(
  ...
  //if(ptLow==3&&ptHigh==6.5)fFinal = new TFile(Form("../../Macros/2021_09_14/roots/2DFit_%s/Final/2DFitResult_%s_%sw_Effw%d_Accw%d_PtW%d_TnP%d_v2.root", SimFit.Data(), kineLabel.Data(), "PR", fEffW, fAccW, isPtW, isTnP));
  //else fFinal = new TFile(Form("../../Macros/2021_09_14/roots/2DFit_%s/Final/2DFitResult_%s_%sw_Effw%d_Accw%d_PtW%d_TnP%d.root", SimFit.Data(), kineLabel.Data(), "PR", fEffW, fAccW, isPtW, isTnP));
  ...
  fv2fit1=new TFile(Form("roots/SignalPDFvariation/%s/SimFitResult_%s_Eff%d_Acc%d_PtW%d_TnP%d_ctau_%.5f_%s_free.root", SimFit.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,ctauLow,"ctauL"));
  fv2fit2=new TFile(Form("roots/SignalPDFvariation/%s/SimFitResult_%s_Eff%d_Acc%d_PtW%d_TnP%d_ctau_%.5f_%.5f_%s_free.root", SimFit.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,ctauLow,ctauHigh,"ctauC"));
  fv2fit3=new TFile(Form("roots/SignalPDFvariation/%s/SimFitResult_%s_Eff%d_Acc%d_PtW%d_TnP%d_ctau_%.5f_%s_free.root", SimFit.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,ctauHigh,"ctauR"));
  ...
  c1->SaveAs(Form("SignalPDFvariation_fraction_vs_v2_%s_free.pdf",kineLabel.Data()));
  ...
  TFile *fv2 = new TFile(Form("SignalPDFvariation_v2_%s_free.root",kineLabel.Data()),"RECREATE");
  fv2->cd();
  prv2->Write();
  npv2->Write();
}
