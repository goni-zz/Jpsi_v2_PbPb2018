...
void doSimultaneousV2MassFit_weight_pt6p5_50_cent80_100(
    int ctauCut=1,
    float ptLow =  6.5, float ptHigh =50,
    float yLow = 0, float yHigh = 2.4,
    int cLow = 80, int cHigh = 100,
    ...
    )
{
  ...
  fMass = new TFile(Form("../../Macros/2021_09_14/roots/2DFit_%s/Mass_CBGauss/Mass_FixedFitResult_%s_%sw_Effw%d_Accw%d_PtW%d_TnP%d_62501.root", DATE.Data(), kineLabel.Data(), "PR", fEffW, fAccW, 1, 1));
