...
void compute_sys_diff_40_80()
{
  ...
  for(int ib=0; ib<nPtBinPR; ib++){
    ...
    if(ib<2) fileAltPR = dirAlt+Form("SignalPDFvariation_v2_pt%.1f-%.1f_y1.6-2.4_muPt0.0_centrality40-80.root",PtBinArrPR[ib],PtBinArrPR[ib+1]);
    else fileAltPR = dirAlt+Form("SignalPDFvariation_v2_pt%.1f-%.1f_y0.0-2.4_muPt0.0_centrality40-80.root",PtBinArrPR[ib],PtBinArrPR[ib+1]);
  ...
  for(int ib=0; ib<nPtBinNP; ib++){
    ...
    if(ib<1) fileAltNP = dirAlt+Form("SignalPDFvariation_v2_pt%.1f-%.1f_y1.6-2.4_muPt0.0_centrality40-80.root",PtBinArrNP[ib],PtBinArrNP[ib+1]);
    else fileAltNP = dirAlt+Form("SignalPDFvariation_v2_pt%.1f-%.1f_y0.0-2.4_muPt0.0_centrality40-80.root",PtBinArrNP[ib],PtBinArrNP[ib+1]);
