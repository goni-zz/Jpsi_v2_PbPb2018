...
void doSimultaneousV2MassFit_weight_pt6p5_9_cent20_120(
    ...
    )
{
  ...
  if(ctauCut==-1){c_ = 0.06; c1_ = -0.01428; c2_ = 0.0284097;}
  else if(ctauCut==0){c_ = 0.05; c1_ = -0.01428; c2_ = 0.0284097;}
  else if(ctauCut==1){c_ = 0.06; c1_ = -0.01428; c2_ = 0.0284097;}
