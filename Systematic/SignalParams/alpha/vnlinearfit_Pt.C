...
void vnlinearfit_Pt(
  ...
  fv2fit1=new TFile(Form("roots/SigPar/%s/SimFitResult_%s_Eff%d_Acc%d_PtW%d_TnP%d_ctau_%.5f_%s.root", SimFit.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,ctauLow,"ctauL"));
  fv2fit2=new TFile(Form("roots/SigPar/%s/SimFitResult_%s_Eff%d_Acc%d_PtW%d_TnP%d_ctau_%.5f_%.5f_%s.root", SimFit.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,ctauLow,ctauHigh,"ctauC"));
  fv2fit3=new TFile(Form("roots/SigPar/%s/SimFitResult_%s_Eff%d_Acc%d_PtW%d_TnP%d_ctau_%.5f_%s.root", SimFit.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,ctauHigh,"ctauR"));
  ...
  c1->SaveAs(Form("SignalParvariation_fraction_vs_v2_%s.pdf",kineLabel.Data()));
  ...
  TFile *fv2 = new TFile(Form("SignalParvariation_v2_%s.root",kineLabel.Data()),"RECREATE");
  fv2->cd();
  prv2->Write();
  npv2->Write();
}
