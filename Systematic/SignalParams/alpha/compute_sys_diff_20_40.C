...
void compute_sys_diff_20_40()
{
  ...
  TString dirNom = "/Users/goni/Documents/CMS/Analysis/Jpsi_Flow/Usercode/Jpsi_v2_PbPb2018/finalPlot/finalPlot_210929/roots/";
  TString dirAlt = "/Users/goni/Documents/CMS/Analysis/Jpsi_Flow/Usercode/Jpsi_v2_PbPb2018/Systematic/SignalParams/alpha/";
  ...
  for(int ib=0; ib<nPtBinPR; ib++){
    cout<<ib<<endl;
    if(ib<2) fileNomPR = dirNom+Form("v2_pt%.1f-%.1f_y1.6-2.4_muPt0.0_centrality40-80.root",PtBinArrPR[ib],PtBinArrPR[ib+1]);
    else fileNomPR = dirNom+Form("v2_pt%.1f-%.1f_y0.0-2.4_muPt0.0_centrality40-80.root",PtBinArrPR[ib],PtBinArrPR[ib+1]);

    if(ib<2) fileAltPR = dirAlt+Form("SignalParVariation_v2_pt%.1f-%.1f_y1.6-2.4_muPt0.0_centrality40-80.root",PtBinArrPR[ib],PtBinArrPR[ib+1]);
    else fileAltPR = dirAlt+Form("SignalParVariation_v2_pt%.1f-%.1f_y0.0-2.4_muPt0.0_centrality40-80.root",PtBinArrPR[ib],PtBinArrPR[ib+1]);
  ...
  for(int ib=0; ib<nPtBinNP; ib++){
    if(ib<1) fileNomNP = dirNom+Form("v2_pt%.1f-%.1f_y1.6-2.4_muPt0.0_centrality40-80.root",PtBinArrNP[ib],PtBinArrNP[ib+1]);
    else fileNomNP = dirNom+Form("v2_pt%.1f-%.1f_y0.0-2.4_muPt0.0_centrality40-80.root",PtBinArrNP[ib],PtBinArrNP[ib+1]);

    if(ib<1) fileAltNP = dirAlt+Form("SignalParVariation_v2_pt%.1f-%.1f_y1.6-2.4_muPt0.0_centrality40-80.root",PtBinArrNP[ib],PtBinArrNP[ib+1]);
    else fileAltNP = dirAlt+Form("SignalParVariation_v2_pt%.1f-%.1f_y0.0-2.4_muPt0.0_centrality40-80.root",PtBinArrNP[ib],PtBinArrNP[ib+1]);
  ...
  TFile *wf = new TFile("SignalParVariation_sys_20_40.root","recreate");
  wf->cd();
  hPtSys_PR->Write();
  hPtSys_NP->Write();
  //for(int ib=0; ib<nPtBinPR; ib++){
