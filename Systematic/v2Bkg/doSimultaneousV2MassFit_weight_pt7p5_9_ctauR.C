...
void doSimultaneousV2MassFit_weight_pt7p5_9_ctauR(
    ...
    )
{
  ...
  Double_t sigma_ = 7.6827e-02;
  //Double_t alpha_ = 1.526;
  Double_t alpha_ = 1.85;
  Double_t n_ = 2.83;
  //Double_t n_ = 2.2;
  Double_t ratio_ = 0.322;
  Double_t frac_ = 0.419;
  //Double_t Bkgmean_ = 7.99882;
  //Double_t Bkgsigma_ = 1.12746;
  Double_t Bkgp0_ = 0.02422;
  Double_t Bkgp1_ = -0.03123;
  Double_t Bkgp2_ = 0.016131;
  Double_t c_ = 0.04911;
  ...
  Double_t parLimitLow[nParmV]  = {     0,        0,   mean_ -0.02,  0.01,   1.0,   1.0, 0,  0,   -30,   -30,  -30,   0, -30, -30, -30};
  Double_t parLimitHigh[nParmV] = { N1_*5,  Nbkg_*5,   mean_ +0.02,  0.08,   9.8,   9.8, 1,  1,    30,    30,   30, 0.1,  30, 30,  30};
  ...
  //TString fitRestxt = Form("../roots/v2Bkg/SimFitResult_%s_%s_Acc%d_Eff%d_%s.txt",bCont.Data(),kineLabel.Data(),fAccW,fEffW,cutName.Data());
  ...
  TF1* fyield_bkg = new TF1("fyield_bkg", TotalYieldBkg, massLow, massHigh);
  ...
  //if (PR==0||PR==1) {c_mass_v2->SaveAs(Form("../figs/v2Bkg/v2Mass_%s_%s_ctau_%.2f.pdf",bCont.Data(), kineLabel.Data(),ctauCut));}
  /*
     Double_t xmass[200];
  ...
  */
  ...
  //  else if (PR==0 || PR==1) {TFile *wf = new TFile(Form("../roots/v2Bkg/SimFitResult_%s_%s_ctau_%.2f.root",bCont.Data(), kineLabel.Data(), ctauCut),"recreate"); wf->cd();}
