...
void drawV2Sig_pt(int PR=0){
  ...
  gr->SetPoint(0,3.5,yPRpt1);
  gr->SetPointError(0,0.5,yPRpt1Err);
  gr->SetPoint(1,4.5,yPRpt2);
  gr->SetPointError(1,0.5,yPRpt2Err);
  gr->SetPoint(2,(5+6.5)/2,yPRpt3);
  gr->SetPointError(2,(6.5-5)/2,yPRpt3Err);
  gr->SetPoint(3,(6.5+8)/2,yPRpt4);
  gr->SetPointError(3,(8-6.5)/2,yPRpt4Err);
  gr->SetPoint(4,(8+12)/2,yPRpt5);
  gr->SetPointError(4,(12-8)/2,yPRpt5Err);
  gr->SetPoint(5,(12+30)/2,yPRpt6);
  gr->SetPointError(5,(30-12)/2,yPRpt6Err);
  ...
  gr->SetPoint(0,(3+4.5)/2,yNPpt1);
  gr->SetPointError(0,(4.5-3)/2,yNPpt1Err);
  gr->SetPoint(1,(4.5+6.5)/2,yNPpt2);
  gr->SetPointError(1,(6.5-4.5)/2,yNPpt2Err);
  gr->SetPoint(2,(6.5+9)/2,yNPpt3);
  gr->SetPointError(2,(9-6.5)/2,yNPpt3Err);
  gr->SetPoint(3,double(9+12)/2,yNPpt4);
  gr->SetPointError(3,double(12-9)/2,yNPpt4Err);
  gr->SetPoint(4,(12+30)/2,yNPpt5);
  gr->SetPointError(4,(30-12)/2,yNPpt5Err);
  }
  ...
  c1->Update();
  c1->SaveAs(Form("%s_v2_pt.pdf",bCont.Data()));
  ...
  TFile *out = new TFile(Form("out_%s_v2_vs_pt.root",bCont.Data()),"recreate");
//  out->cd();
