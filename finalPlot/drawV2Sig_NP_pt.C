...
void drawV2Sig_PR_pt(){
  ...
  TFile *fPt1 = new TFile("../roots/v2mass_fit/SimFitResult_Prompt_pt3.0-4.0_y1.6-2.4_muPt0.0_centrality20-120_m2.6-3.5_OS.root","read");
  TFile *fPt2 = new TFile("../roots/v2mass_fit/SimFitResult_Prompt_pt4.0-5.0_y1.6-2.4_muPt0.0_centrality20-120_m2.6-3.5_OS.root","read");
  TFile *fPt3 = new TFile("../roots/v2mass_fit/SimFitResult_Prompt_pt5.0-6.5_y1.6-2.4_muPt0.0_centrality20-120_m2.6-3.5_OS.root","read");
  TFile *fPt4 = new TFile("../roots/v2mass_fit/SimFitResult_Prompt_pt6.5-8.0_y1.6-2.4_muPt0.0_centrality20-120_m2.6-3.5_OS.root","read");
  TFile *fPt5 = new TFile("../roots/v2mass_fit/SimFitResult_Prompt_pt8.0-12.0_y1.6-2.4_muPt0.0_centrality20-120_m2.6-3.5_OS.root","read");
  TFile *fPt6 = new TFile("../roots/v2mass_fit/SimFitResult_Prompt_pt12.0-30.0_y1.6-2.4_muPt0.0_centrality20-120_m2.6-3.5_OS.root","read");
  ...
  gr->SetPoint(0,3.5,yPt1);
  gr->SetPointError(0,0.5,yPt1Err);
  gr->SetPoint(1,4.5,yPt2);
  gr->SetPointError(1,0.5,yPt2Err);
  gr->SetPoint(2,(5+6.5)/2,yPt3);
  gr->SetPointError(2,(6.5-5)/2,yPt3Err);
  gr->SetPoint(3,(6.5+8)/2,yPt4);
  gr->SetPointError(3,(8-6.5)/2,yPt4Err);
  gr->SetPoint(4,(8+12)/2,yPt5);
  gr->SetPointError(4,(12-8)/2,yPt5Err);
  gr->SetPoint(5,(12+30)/2,yPt6);
  gr->SetPointError(5,(30-12)/2,yPt6Err);
  ...
  drawText("1.6 < |y^{#mu#mu}| < 2.4", pos_x_mass,pos_y-pos_y_diff*0.5,text_color,text_size);
  drawText("Cent.10-60%", pos_x_mass,pos_y-pos_y_diff,text_color,text_size);
