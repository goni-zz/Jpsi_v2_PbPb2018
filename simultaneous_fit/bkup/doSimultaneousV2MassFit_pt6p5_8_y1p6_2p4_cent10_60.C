...
void doSimultaneousV2MassFit_pt6p5_8_y1p6_2p4_cent10_60(int cLow = 20, int cHigh = 120,
    float ptLow =  6.5, float ptHigh = 8.0,
    float yLow = 1.6, float yHigh = 2.4,
    float SiMuPtCut = 0, float massLow = 2.6, float massHigh =3.5, bool dimusign=true, int ibkg_vn_sel = fpol2,
    int PR=0, float ctauCut=0.08) // PR 0 : PR, 1 : NP, 2 : Inc
    //int PR=1, float ctauCut=0.2) // PR 0 : PR, 1 : NP, 2 : Inc
{
  TString bCont;
