...
void doSimultaneousV2MassFit_PR_pt45_cent1060_test(int cLow = 20, int cHigh = 120,
    float ptLow =  4, float ptHigh = 5,
...
//  fyield_bkg->SetFillColor(kAzure-9);
  ...
  drawText("L_{J/#psi} 0.0525",pos_x_mass,pos_y-pos_y_diff*5,text_color,text_size);
