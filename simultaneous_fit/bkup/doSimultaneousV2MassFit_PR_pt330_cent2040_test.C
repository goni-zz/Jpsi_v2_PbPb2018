...
void doSimultaneousV2MassFit_PR_pt330_cent2040_test(int cLow = 20, int cHigh = 40,
...
//  fyield_bkg->SetFillColor(kAzure-9);
  ...
  drawText("L_{J/#psi} 0.0375",pos_x_mass,pos_y-pos_y_diff*5,text_color,text_size);
