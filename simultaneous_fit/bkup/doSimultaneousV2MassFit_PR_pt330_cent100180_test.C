...
void doSimultaneousV2MassFit_PR_pt330_cent100180_test(int cLow = 100, int cHigh = 180,
    ...
    float SiMuPtCut = 0, float massLow = 2.6, float massHigh =3.5, bool dimusign=true, int ibkg_vn_sel = fpol2)
{
  ...
  Double_t parLimitHigh[nParmV] = {N1_*5, Nbkg_*5, mean_ +0.02,  0.06,     3.,    2.5,   1, 1,     25,  0.5,  5,  5,  4};
