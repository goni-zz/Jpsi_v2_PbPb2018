...
void doSimultaneousV2MassFit_PR_pt330_cent60120_test(int cLow = 60, int cHigh = 120,
    ...
    float SiMuPtCut = 0, float massLow = 2.6, float massHigh =3.5, bool dimusign=true, int ibkg_vn_sel = fpol2)
{
  ...
  Double_t parLimitLow[nParmV]  = {      0,     0, mean_ -0.02,  0.01,   1.1,   1.1,   0,0,   -50,     0, -5, -5, -4};
  Double_t parLimitHigh[nParmV] = {N1_*5, Nbkg_*5, mean_ +0.02,  0.08,   1.9,   2.1,   1, 1,    50,  0.3,  5,  5,  4};
