...
void doSimultaneousV2MassFit_PR_pt812_cent1060_test(int cLow = 20, int cHigh = 120,
    ...
    float SiMuPtCut = 0, float massLow = 2.6, float massHigh =3.5, bool dimusign=true, int ibkg_vn_sel = fpol2)
{
  ...
  Double_t parLimitHigh[nParmV] = {N1_*5, Nbkg_*5, mean_ +0.02,  0.08,   3.8,   2.9, 1, 1,    25,  0.3,  5,  5,  4};
...
//  fyield_bkg->SetFillColor(kAzure-9);
  ...
  drawText("L_{J/#psi} 0.0335",pos_x_mass,pos_y-pos_y_diff*5,text_color,text_size);
