...
void doSimultaneousV2MassFit_NP_pt1230_cent1060_test(int cLow = 20, int cHigh = 120,
...
//  fyield_bkg->SetFillColor(kAzure-9);
  ...
  drawText("L_{J/#psi} 0.0505",pos_x_mass,pos_y-pos_y_diff*5,text_color,text_size);
