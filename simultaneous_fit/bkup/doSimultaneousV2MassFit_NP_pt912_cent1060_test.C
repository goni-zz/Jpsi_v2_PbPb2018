...
void doSimultaneousV2MassFit_NP_pt912_cent1060_test(int cLow = 20, int cHigh = 120,
    ...
    float SiMuPtCut = 0, float massLow = 2.6, float massHigh =3.5, bool dimusign=true, int ibkg_vn_sel = fpol2)
{
  ...
  Double_t parLimitLow[nParmV]  = {      0,     0, mean_ -0.02,  0.01,   1.1,   1.1, 0, 0,     0,    0, -5, -5, -4};
  Double_t parLimitHigh[nParmV] = {N1_*5, Nbkg_*5, mean_ +0.02,  0.08,   2.9,   3.1, 1, 1,    20,  0.5,  5,  5,  4};
