...
void doSimultaneousV2MassFit_pt1030_cent1060_test(int cLow = 20, int cHigh = 120,
    float ptLow =  10, float ptHigh = 30,
    ...
    float SiMuPtCut = 0, float massLow = 2.6, float massHigh =3.5, bool dimusign=true, int ibkg_vn_sel = fpol2)
{
  ...
  Double_t parLimitHigh[nParmV] = {N1_*5, Nbkg_*5, mean_ +0.02,  0.09,   9.8,   9.8, 1, 1,    0.6,  0.3,  5,  5,  4};
