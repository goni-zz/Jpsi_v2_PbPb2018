...
void doSimultaneousV2MassFit_PR_pt330_cent4060_test(int cLow = 40, int cHigh = 60,
    ...
    float SiMuPtCut = 0, float massLow = 2.6, float massHigh =3.5, bool dimusign=true, int ibkg_vn_sel = fpol2)
{
  ...
  Double_t parLimitHigh[nParmV] = {N1_*5, Nbkg_*5, mean_ +0.02,  0.06,     3.,    3.55,   1, 1,     25,  0.5,  5,  5,  4};
