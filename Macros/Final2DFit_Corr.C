    ...
    )
{
  ...
  if(DATE=="0_180") fCTrue = new TFile(Form("roots/2DFit_%s/CtauTrue/CtauTrueResult_Inclusive_pt6.5-50.0_y0.0-2.4_muPt0.0_centrality0-180.root","210509"));
  ...
  //3-4.5
  if(ptLow==12&&ptHigh==15&&cLow==20&&cHigh==120) ws->factory("b_Jpsi[0.40, 0., 1.0]");//NP fraction for Sig
