    ...
    )
{
  ...
  gSystem->mkdir(Form("roots/2DFit_%s/Final_v2Bins",DATE.Data()),kTRUE);
  gSystem->mkdir(Form("figs/2DFit_%s/Final_v2Bins", DATE.Data()),kTRUE);
  ...
  f1 = new TFile(Form("/Users/hwan/tools/2019/CMS/JPsi/Jpsi_v2_PbPb2018/skimmedFiles/v2Cut_TnPSys1/OniaRooDataSet_isMC0_JPsi_%s_m2.6-3.5_OS_Effw%d_Accw%d_PtW%d_TnP%d_%s_220119.root",kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,DATE.Data()));
  ...
  //if (ptLow<20&&v2==2.1) v2Cut = Form("&& v2>%.2f && v2<%.2f",v2,v2+0.6);
  // else if (ptLow>=20&&abs(v2)>=1.8)  v2Cut = Form("&& v2>%.2f && v2<%.2f",v2,v2+0.9);
  // else if (ptLow>=20&&abs(v2)>=1.2&&abs(v2)<1.8)  v2Cut = Form("&& v2>%.2f && v2<%.2f",v2,v2+0.6);
  // else if (v2==-10) v2Cut = Form("&& v2>%.2f && v2<%.2f",v2,10.0);
  // else if (ptLow<20&&v2==-2.7) v2Cut = Form("&& v2>%.2f && v2<%.2f",v2,v2+0.6);
  // else v2Cut = Form("&& v2>%.2f && v2<%.2f", v2, v2+0.3);
  OS="recoQQsign==0 &&";
  ...
  //fCTrue = new TFile(Form("/Users/hwan/tools/2019/CMS/JPsi/Jpsi_v2_PbPb2018/roots/2DFit_%s/CtauTrue/CtauTrueResult_Inclusive_%s.root","Corr",kineLabel.Data()));
...
//  ctauErrMax = 0.06;}//0.124872
  ...
  if(ptLow==6.5&&ptHigh==7.5&&cLow==20&&cHigh==120&&v2==-0.3) ws->factory("b_Jpsi[0.23, .22, .26]");//NP fraction for Sig
...
//  else if(ptLow==6.5&&ptHigh==50&&cLow==100&&cHigh==180) ws->factory("b_Jpsi[0.31, 0.3, 1.]");//NP fraction for Sig
  ...
  //if (ptLow<20&&v2==2.1) drawText(Form("%.1f < v_{2} < %.1f",v2,v2+0.6),text_x+0.5,text_y-y_diff*7,text_color,text_size); 
  //else if (ptLow>=20&&abs(v2)>=1.8) drawText(Form("%.1f < v_{2} < %.1f",v2,v2+0.9),text_x+0.5,text_y-y_diff*7,text_color,text_size);
  //else if (ptLow>=20&&abs(v2)>=1.2&&abs(v2)<1.8)  drawText(Form("%.1f < v_{2} < %.1f",v2,v2+0.6),text_x+0.5,text_y-y_diff*7,text_color,text_size);
  //else if (ptLow<20&&v2==-2.7) drawText(Form("%.1f < v_{2} < %.1f",v2,v2+0.6),text_x+0.5,text_y-y_diff*7,text_color,text_size);
  //2else drawText(Form("%.1f < v_{2} < %.1f",v2,v2+0.3),text_x+0.5,text_y-y_diff*7,text_color,text_size);
  if(v2==2.1) drawText(Form("%.1f < v_{2} < %.1f",v2,v2+0.6),text_x+0.5,text_y-y_diff*7,text_color,text_size);
  else if (ptLow==25&&ptHigh==50&&v2==1.8) drawText(Form("%.1f < v_{2} < %.1f",v2,v2+0.9),text_x+0.5,text_y-y_diff*7,text_color,text_size);
  else if (ptLow==25&&ptHigh==50&&v2==-2.7) drawText(Form("%.1f < v_{2} < %.1f",v2,v2+0.9),text_x+0.5,text_y-y_diff*7,text_color,text_size);
  else if (ptLow==25&&ptHigh==50&&v2==-1.8) drawText(Form("%.1f < v_{2} < %.1f",v2,v2+0.6),text_x+0.5,text_y-y_diff*7,text_color,text_size);
  else if (ptLow==25&&ptHigh==50&&v2==1.2) drawText(Form("%.1f < v_{2} < %.1f",v2,v2+0.6),text_x+0.5,text_y-y_diff*7,text_color,text_size);
  else if (ptLow==20&&ptHigh==25&&v2==1.8) drawText(Form("%.1f < v_{2} < %.1f",v2,v2+0.9),text_x+0.5,text_y-y_diff*7,text_color,text_size);
  else if (ptLow==20&&ptHigh==25&&v2==-2.7) drawText(Form("%.1f < v_{2} < %.1f",v2,v2+0.9),text_x+0.5,text_y-y_diff*7,text_color,text_size);
  else if(v2==-2.7) drawText(Form("%.1f < v_{2} < %.1f",v2,v2+0.6),text_x+0.5,text_y-y_diff*7,text_color,text_size);
  else drawText(Form("%.1f < v_{2} < %.1f",v2,v2+0.3),text_x+0.5,text_y-y_diff*7,text_color,text_size);
  //if(v2==2.1) drawText(Form("%.1f < v_{2} < %.1f",v2,v2+0.6),text_x+0.5,text_y-y_diff*7,text_color,text_size);
  //else if (ptLow==25&&ptHigh==50&&v2==1.8) drawText(Form("%.1f < v_{2} < %.1f",v2,v2+0.9),text_x+0.5,text_y-y_diff*7,text_color,text_size); 
  //else if (ptLow==25&&ptHigh==50&&v2==-2.7) drawText(Form("%.1f < v_{2} < %.1f",v2,v2+0.9),text_x+0.5,text_y-y_diff*7,text_color,text_size);
  //else if (ptLow==25&&ptHigh==50&&v2==-1.8) drawText(Form("%.1f < v_{2} < %.1f",v2,v2+0.6),text_x+0.5,text_y-y_diff*7,text_color,text_size);
  ...
  ofstream of1(Form("figs/2DFit_%s/Final_v2Bins/2DFit_Ctau_%s_%sw_Effw%d_Accw%d_PtW%d_TnP%d_Left.txt", DATE.Data(), kineLabel.Data(), fname.Data(), fEffW, fAccW, isPtW, isTnP));
  ofstream of2(Form("figs/2DFit_%s/Final_v2Bins/2DFit_Ctau_%s_%sw_Effw%d_Accw%d_PtW%d_TnP%d_Righ.txt", DATE.Data(), kineLabel.Data(), fname.Data(), fEffW, fAccW, isPtW, isTnP));
  ofstream of3(Form("figs/2DFit_%s/Final_v2Bins/2DFit_Ctau_%s_%sw_Effw%d_Accw%d_PtW%d_TnP%d_Cent.txt", DATE.Data(), kineLabel.Data(), fname.Data(), fEffW, fAccW, isPtW, isTnP));
 ...
 //ws->var("ctau3D")->setRange("ctauCent", 0.03, 0.11); // Input Left, Right l_jpsi
  ...
  c_G->Update();
  c_G->SaveAs(Form("figs/2DFit_%s/Final_v2Bins/2DFit_Ctau_%s_%sw_Effw%d_Accw%d_PtW%d_TnP%d_v2_%.2f.pdf", DATE.Data(), kineLabel.Data(), fname.Data(), fEffW, fAccW, isPtW, isTnP, v2));
  c_H->Update();
  c_H->SaveAs(Form("figs/2DFit_%s/Final_v2Bins/2DFit_Mass_%s_%sw_Effw%d_Accw%d_PtW%d_TnP%d_v2_%.2f.pdf", DATE.Data(), kineLabel.Data(), fname.Data(), fEffW, fAccW, isPtW, isTnP, v2));
  ...
  cor.Print();
  TFile *outFile = new TFile(Form("roots/2DFit_%s/Final_v2Bins/2DFitResult_%s_%sw_Effw%d_Accw%d_PtW%d_TnP%d_v2_%.2f.root", DATE.Data(), kineLabel.Data(), fname.Data(), fEffW, fAccW, isPtW, isTnP, v2),"recreate");
  //ws->Write();
  outFile->cd();
  outh->Write();
  outh1->Write();
