    ...
    )
{
  ...
  c_G->Update();
  c_G->SaveAs(Form("figs/2DFit_%s/Final_v2Bins/2DFit_Ctau_%s_%sw_Ef%d_Ac%d_Pt%d_TnP%d_v2_%.2f.pdf", DATE.Data(), kineLabel.Data(), fname.Data(), fEffW, fAccW, isPtW, isTnP, v2));
  ...
  c_H->Update();
  c_H->SaveAs(Form("figs/2DFit_%s/Final_v2Bins/2DFit_Mass_%s_%sw_Ef%d_Ac%d_Pt%d_TnP%d_v2_%.2f.pdf", DATE.Data(), kineLabel.Data(), fname.Data(), fEffW, fAccW, isPtW, isTnP, v2));
