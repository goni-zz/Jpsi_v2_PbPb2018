        ...
        )
{
    ...
    //const int nV2Bins=16;
    //double v2Bin[nV2Bins+1] = {-2.4,-2.1,-1.8,-1.5,-1.2,-0.9,-0.6,-0.3,0.,0.3,0.6,0.9,1.2,1.5,1.8,2.1,2.4};
    double frac[nV2Bins];
    double fracErr[nV2Bins];

    TH1D* hPR = new TH1D("hPR",";v_{3};",nV2Bins,v2Bin);
    TH1D* hNP = new TH1D("hNP",";v_{3};",nV2Bins,v2Bin);
    ...
    TFile *outFile;
    outFile = new TFile(Form("./v3_D0method_%s_TnPSys2.root",kineLabel.Data()),"recreate");
    outFile->cd();
    hOutPR->Write();
    hOutNP->Write();
