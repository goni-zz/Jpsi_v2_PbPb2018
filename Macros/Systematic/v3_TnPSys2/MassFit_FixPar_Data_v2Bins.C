    ...
    )
{
  ...
  f1 = new TFile(Form("../../../skimmedFiles/v3Cut_TnPSys2/OniaRooDataSet_isMC0_JPsi_%s_m2.6-3.5_OS_Effw%d_Accw%d_PtW%d_TnP%d_%s_220119.root",kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,DATE.Data()));
...
//  f1 = new TFile("/Users/hwan/tools/2019/CMS/JPsi/Jpsi_v2_PbPb2018/skimmedFiles/vnCut/OniaRooDataSet_isMC0_JPsi_pt3.0-4.5_y1.6-2.4_muPt0.0_centrality20-120_m2.6-3.5_OS_Effw0_Accw0_PtW1_TnP1_211110.root");
  ...
  if(ptLow==6.5 && cLow == 80 && v2 == -1.5) {
      NBkg_limit = 2.0e+05;
      NJpsi_limit = 10.0e+04;
  }

  if(ptLow==6.5 && cLow == 80 && v2 == -2.1) {
      NBkg_limit = 2.0e+05;
      NJpsi_limit = 10.0e+04;
  }

  if(ptLow==6.5 && cLow == 80 && v2 == 1.2) {
      NBkg_limit = 2.0e+05;
      NJpsi_limit = 10.0e+04;
  }
...
//
  ...
  if(ptLow==6.5 && ptHigh==9 && cLow == 20 && cHigh == 120 && v2 == -1.2) {
      NBkg_limit = 10.0e+06;
      NJpsi_limit = 10.0e+06;
  }
  ...
  if(ptLow==15 && ptHigh == 50 && v2 == -1.5) {
      NBkg_limit = 3.0e+05;
      NJpsi_limit = 10.0e+04;
  }

  if(ptLow==15 && ptHigh == 50 && v2 == -0.3) {
      NBkg_limit = 3.0e+05;
      NJpsi_limit = 10.0e+04;
  }
