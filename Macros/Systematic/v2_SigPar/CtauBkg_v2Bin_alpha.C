    ...
    )
{
  ...
  gSystem->mkdir(Form("roots/2DFit_%s/CtauBkg_v2Bins_alpha",DATE.Data()),kTRUE);
  gSystem->mkdir(Form("figs/2DFit_%s/CtauBkg_v2Bins_alpha",DATE.Data()),kTRUE);
  ...
  fMass = new TFile(Form("roots/2DFit_%s/Mass_v2Bins_alpha/Mass_FixedFitResult_%s_%sw_Effw%d_Accw%d_PtW%d_TnP%d_v2_%.2f.root", DATE.Data(), kineLabel.Data(), fname.Data(), fEffW, fAccW, isPtW, isTnP, v2));
  fCErr = new TFile(Form("roots/2DFit_%s/CtauErr_v2Bins_alpha/CtauErrResult_%s_%sw_Effw%d_Accw%d_PtW%d_TnP%d_v2_%.2f.root", DATE.Data(), kineLabel.Data(), fname.Data(), fEffW, fAccW, isPtW, isTnP, v2));
  fCRes = new TFile(Form("roots/2DFit_%s/CtauRes_v2Bins_alpha/CtauResResult_%s_%sw_Effw%d_Accw%d_PtW%d_TnP%d_v2_%.2f.root", DATE.Data(), kineLabel.Data(), fname.Data(), fEffW, fAccW, isPtW, isTnP, v2));
  ...
  ws->factory("fDLIV[0.16, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.1, 1e-6, 1.]");
  ws->factory("lambdaDF_Bkg[0.01, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.4, 1e-6, 1.]");}
  else if(v2==-0.6&&ptLow==6.5&&ptHigh==7.5){
  ws->factory("b_Bkg[0.6, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.52, 1e-6, 1.]");
  ws->factory("fDLIV[0.27, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.1, 1e-6, 1.]");
  ws->factory("lambdaDF_Bkg[0.01, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.46, 1e-6, 1.]");}
  else if(v2==-2.7&&ptLow==6.5&&ptHigh==7.5){
  ws->factory("b_Bkg[0.6, 1e-6, 1.]");//NP fraction for bkg
  ...
  ws->factory("lambdaDF_Bkg[0.01, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.4, 1e-6, 1.]");}
  else if(v2==0.3&&ptLow==20&&ptHigh==25){
  ws->factory("b_Bkg[0.6, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.4, 1e-6, 1.]");
  ws->factory("fDLIV[0.5, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.3, 1e-6, 1.]");
  ws->factory("lambdaDF_Bkg[0.01, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.4, 1e-6, 1.]");}
  else if(v2==1.5&&ptLow==20&&ptHigh==25){
  ws->factory("b_Bkg[0.6, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.4, 1e-6, 1.]");
  ws->factory("fDLIV[0.5, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.16, 1e-6, 1.]");
  ws->factory("lambdaDF_Bkg[0.01, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.4, 1e-6, 1.]");}
  ...
  ws->factory("fDFSS[0.8, 1e-6, 1.]");
  ws->factory("fDLIV[0.5, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.34, 1e-6, 1.]");
  ws->factory("lambdaDF_Bkg[0.01, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.2, 1e-6, 1.]");}
/*
  else if(v2==2.1&&ptLow==6.5&&ptHigh==7.5){
  ...
  else if(v2==-1.8&ptLow==7.5&&ptHigh==9) { ctauMin=-1.; ctauMax=3.; }
...
//  else if(v2==-1.8&&ptLow==25&&ptHigh==50) ctauMax=1.;
  ...
  else if (v2==1.5&&cLow==60&&cHigh==80) {ctauMin=-1.;}
  else if (v2==1.8&&cLow==60&&cHigh==80) {ctauMin=-1.;}
...
//  RooDataSet* dataToFit = (RooDataSet*)dataw_Bkg->reduce(Form("ctau3D>=%.f&&ctau3D<=%.f",-2.0, 4.0))->Clone("dataw_Bkg");
  ...
  c_E->Update();
  c_E->SaveAs(Form("figs/2DFit_%s/CtauBkg_v2Bins_alpha/Bkg_%s_%sw_Effw%d_Accw%d_PtW%d_TnP%d_v2_%.2f.pdf", DATE.Data(), kineLabel.Data(), fname.Data(), fEffW, fAccW, isPtW, isTnP, v2));
  ...
  TFile *outFile = new TFile(Form("roots/2DFit_%s/CtauBkg_v2Bins_alpha/CtauBkgResult_%s_%sw_Effw%d_Accw%d_PtW%d_TnP%d_v2_%.2f.root", DATE.Data(), kineLabel.Data(), fname.Data(), fEffW, fAccW, isPtW, isTnP, v2),"recreate");
  fitCtauBkg->Write();
