...
//  f1 = new TFile("/Users/hwan/tools/2019/CMS/JPsi/Jpsi_v2_PbPb2018/skimmedFiles/vnCut/OniaRooDataSet_isMC0_JPsi_pt3.0-4.5_y1.6-2.4_muPt0.0_centrality20-120_m2.6-3.5_OS_Effw0_Accw0_PtW1_TnP1_211110.root");
  ...
  else if (v2==-10) v2Cut = Form("&& v2>%.2f && v2<%.2f",v2,10.0);
  ...
  if(v2==-1.2&&ptLow==3&&ptHigh==4.5) sigma_index = 1;
  else if(v2==0&&ptLow==3&&ptHigh==4.5) sigma_index = 1;
  else if(v2==-0.3&&ptLow==3&&ptHigh==4.5) sigma_index = 1;
  else if(v2==0.3&&ptLow==3&&ptHigh==4.5) sigma_index = 1;
  else if(v2==0.6&&ptLow==3&&ptHigh==4.5) sigma_index = 1;
  else if(v2==1.2&&ptLow==3&&ptHigh==4.5) sigma_index = 2;
  else if(v2==1.5&&ptLow==3&&ptHigh==4.5) sigma_index = 1;
  else if(v2==-1.5&&ptLow==3&&ptHigh==4.5) sigma_index = 1;
  else if(v2==-1.8&&ptLow==3&&ptHigh==4.5) sigma_index = 1;
  else if(v2==-2.1&&ptLow==3&&ptHigh==4.5) sigma_index = 1;

  else if(v2==-0.3&&ptLow==4.5&&ptHigh==6.5) sigma_index = 1;
  else if(v2==-0.6&&ptLow==4.5&&ptHigh==6.5) sigma_index = 1;
  else if(v2==-0.9&&ptLow==4.5&&ptHigh==6.5) sigma_index = 1;
  else if(v2==-1.2&&ptLow==4.5&&ptHigh==6.5) sigma_index = 1;
  else if(v2==-1.8&&ptLow==4.5&&ptHigh==6.5) sigma_index = 1;
  else if(v2==0&&ptLow==4.5&&ptHigh==6.5) sigma_index = 1;
  else if(v2==0.3&&ptLow==4.5&&ptHigh==6.5) sigma_index = 1;
  else if(v2==0.9&&ptLow==4.5&&ptHigh==6.5) sigma_index = 1;
  else if(v2==1.2&&ptLow==4.5&&ptHigh==6.5) sigma_index = 1;
  else if(v2==1.8&&ptLow==4.5&&ptHigh==6.5) sigma_index = 1;

  else if(v2==-0.3&&ptLow==6.5&&ptHigh==7.5) sigma_index = 1;
  else if(v2==-0.6&&ptLow==6.5&&ptHigh==7.5) sigma_index = 1;
  else if(v2==-1.2&&ptLow==6.5&&ptHigh==7.5) sigma_index = 1;
  else if(v2==-2.7&&ptLow==6.5&&ptHigh==7.5) sigma_index = 3;
  else if(v2==0&&ptLow==6.5&&ptHigh==7.5) sigma_index = 1;
  else if(v2==0.3&&ptLow==6.5&&ptHigh==7.5) sigma_index = 1;
  else if(v2==0.6&&ptLow==6.5&&ptHigh==7.5) sigma_index = 1;
  else if(v2==1.2&&ptLow==6.5&&ptHigh==7.5) sigma_index = 1;

  else if(v2==1.5&&ptLow==7.5&&ptHigh==9) sigma_index = 3;
  
  else if(v2==0.3&&ptLow==12&&ptHigh==15) sigma_index = 3;

  else if(v2==0.6&&ptLow==20&&ptHigh==25) sigma_index = 3;

  else if(v2==-0.3&&cLow==0&&cHigh==20) sigma_index = 1;
  else if(v2==0.&&cLow==0&&cHigh==20) sigma_index = 3;
  else if(v2==0.6&&cLow==0&&cHigh==20) sigma_index = 1;
  else if(v2==1.5&&cLow==0&&cHigh==20) sigma_index = 3;

  else if(v2==-0.3&&cLow==20&&cHigh==40) sigma_index = 3;

  else if(v2==-0.3&&cLow==40&&cHigh==60) sigma_index = 3;
  else if(v2==0.3&&cLow==40&&cHigh==60) sigma_index = 3;

  else if(v2==0&&cLow==60&&cHigh==80) sigma_index = 3;

  else if(v2==-0.3&&cLow==80&&cHigh==100) sigma_index = 1;
  else if(v2==-0.6&&cLow==80&&cHigh==100) sigma_index = 3;
  else if(v2==-0.9&&cLow==80&&cHigh==100) sigma_index = 3;
  else if(v2==0.&&cLow==80&&cHigh==100) sigma_index = 1;
  else if(v2==0.3&&cLow==80&&cHigh==100) sigma_index = 3;
  else if(v2==0.6&&cLow==80&&cHigh==100) sigma_index = 1;
  else if(v2==1.2&&cLow==80&&cHigh==100) sigma_index = 3;
  ...
  Double_t NJpsi_limit = 10.0e+06;
   if (ptLow==15&&ptHigh==50)  {
      NBkg_limit = 1.0e+04;
      NJpsi_limit = 1.0e+04; }
  else if (v2==-1.5&&ptLow==3&&ptHigh==4.5)  {
      NBkg_limit = 1e+08;
      NJpsi_limit = 3.0e+05; }
  else if (v2==0&&ptLow==3&&ptHigh==4.5)  {
      NBkg_limit = 3e+07;
      NJpsi_limit = 3.2e+05; }
  else if (v2==-0.9&&ptLow==3&&ptHigh==4.5)  {
      NBkg_limit = 1e+08;
      NJpsi_limit = 3.0e+05; }
  else if (v2==1.2&&ptLow==3&&ptHigh==4.5)  {
      NBkg_limit = 1e+06;
      NJpsi_limit = 2.0e+05; }
  else if (v2==1.5&&ptLow==3&&ptHigh==4.5)  {
      NBkg_limit = 1e+06;
      NJpsi_limit = 3.5e+04; }
  else if (v2==1.8&&ptLow==3&&ptHigh==4.5)  {
      NBkg_limit = 2e+05;
      NJpsi_limit = 3.0e+04; }
  else if (v2==-2.1&&ptLow==3&&ptHigh==4.5)  {
      NBkg_limit = 1e+06;
      NJpsi_limit = 1e+05; }
  else if (v2==-1.8&&ptLow==3&&ptHigh==4.5)  {
      NBkg_limit = 1e+06;
      ...
      NBkg_limit = 1e+07;
      NJpsi_limit = 3.0e+05; }
  else if (v2==-2.7&&ptLow==3&&ptHigh==4.5)  {
      NBkg_limit = 1e+05;
      NJpsi_limit = 3.0e+04; }
  else if (ptLow==3&&ptHigh==4.5)  {
      NBkg_limit = 2e+07;
      NJpsi_limit = 5.0e+06; }
  else if (v2==1.8&&ptLow==4.5&&ptHigh==6.5)  {
      NBkg_limit = 3e+04;
      NJpsi_limit = 2.0e+04; }
...
//      NJpsi_limit = 1.0e+05; }
      ...
      NBkg_limit = 2.0e+05;
      NJpsi_limit = 2.0e+05; }
  else if (v2==-1.2&&ptLow==7.5&&ptHigh==9)  {
      NBkg_limit = 2.0e+04;
      NJpsi_limit = 2.0e+04; }
      ...
      NBkg_limit = 2.0e+04;
      NJpsi_limit = 4.0e+04; }
  else if (v2==0.3&&ptLow==12&&ptHigh==15)  {
      NBkg_limit = 3.0e+03;
      NJpsi_limit = 1.0e+04; }
      ...
      NBkg_limit = 1.0e+04;
      NJpsi_limit = 1.0e+04; }
  else if (v2==0.6&&ptLow==20&&ptHigh==25)  {
      NBkg_limit = 300;
      NJpsi_limit = 800; }
  else if (ptLow==20&&ptHigh==25)  {
      NBkg_limit = 5.0e+03;
      NJpsi_limit = 2.0e+03; }
//  else if (v2==1.5&&cLow==0&&cHigh==20){
//      NBkg_limit = 2.5e+04;
//      NJpsi_limit = 1.5e+04;  }
      ...
      NBkg_limit = 5.0e+05;
      NJpsi_limit = 5.0e+04;  }
  else if (v2==-0.3&&cLow==20&&cHigh==40){
      NBkg_limit = 7e+04;
      NJpsi_limit = 6e+04;  }
  else if (v2==1.5&&cLow==20&&cHigh==40){
      NBkg_limit = 2.5e+04;
      NJpsi_limit = 1.5e+04;  }
  else if (cLow==20&&cHigh==40){
      NBkg_limit = 1.0e+05;
      NJpsi_limit = 7.0e+04;  }
  else if (v2==0.3&&cLow==40&&cHigh==60){
      NBkg_limit = 6.0e+04;
      NJpsi_limit = 6.0e+04;  }
      ...
      NBkg_limit = 2.0e+04;
      NJpsi_limit = 3.0e+04;  }
  else if (v2==0.6&&cLow==80&&cHigh==100){
      NBkg_limit = 1.5e+04;
      NJpsi_limit = 2.0e+04;  }
