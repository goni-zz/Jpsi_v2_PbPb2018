...
void D0_method_pt_errmod_f_pt25_50(
        ...
        )
{
    ...
    c1->SaveAs(Form("plot_D0method_f_%s.png",kineLabel.Data()));
    c1->SaveAs(Form("plot_D0method_f_%s.pdf",kineLabel.Data()));
    ...
    c2->SaveAs(Form("plot_D0method_bfractions_f_%s.png",kineLabel.Data()));
    c2->SaveAs(Form("plot_D0method_bfractions_f_%s.pdf",kineLabel.Data()));
