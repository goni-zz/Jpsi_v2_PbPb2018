...
void drawV2Sig_nPart_D0method(){
  ...
  //float centBin[nCentBins+1]={27.12,87.19,131.0,188.2,262.3,356.9};
...
//  
  ...
  c1->Update();
  c1->SaveAs(Form("new_v2_npart.pdf"));
  ...
  TFile *out = new TFile(Form("out_new_v2_vs_npart.root"),"recreate");
//  out->cd();
