...
//  ctauErrMax = 0.06;}//0.124872
  ...
  //ws->var("m_{J/#Psi}")->setConstant();
  //ws->var("alpha_1_A")->setConstant();
  //ws->var("n_1_A")->setConstant();
  //ws->var("sigma_1_A")->setConstant();
  //ws->var("sl1")->setConstant();
  //ws->var("x_A")->setConstant();
  //ws->var("f")->setConstant();
