#include <iostream>
#include "/Users/hwan/tools/2019/CMS/JPsi/Jpsi_v2_PbPb2018/rootFitHeaders.h"
#include "/Users/hwan/tools/2019/CMS/JPsi/Jpsi_v2_PbPb2018/commonUtility.h"
#include "/Users/hwan/tools/2019/CMS/JPsi/Jpsi_v2_PbPb2018/JpsiUtility.h"
...
#include "TArrow.h"
#include "TFile.h"
#include "/Users/hwan/tools/2019/CMS/JPsi/Jpsi_v2_PbPb2018/cutsAndBin.h"
#include "/Users/hwan/tools/2019/CMS/JPsi/Jpsi_v2_PbPb2018/CMS_lumi_v2mass.C"
#include "/Users/hwan/tools/2019/CMS/JPsi/Jpsi_v2_PbPb2018/tdrstyle.C"
    ...
    )
{
  ...
  gSystem->mkdir(Form("roots/2DFit_%s/CtauBkg_v2Bins",DATE.Data()),kTRUE);
  gSystem->mkdir(Form("figs/2DFit_%s/CtauBkg_v2Bins",DATE.Data()),kTRUE);
  ...
  ws->factory("fDFSS[0.05, 1e-6, 1.]");
  ws->factory("fDLIV[0.05, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.3, 1e-6, 1.]");
  ws->factory("lambdaDF_Bkg[ 0.01, 1e-5, 1.]");
  ...
  ws->factory("fDFSS[0.57, 1e-6, 1.]");
  ws->factory("fDLIV[0.6, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.05, 1e-8, 1.]");
  ws->factory("lambdaDF_Bkg [0.01, 1e-8, 1.]");
  ws->factory("lambdaDSS_Bkg[0.1, 1e-8, 1.]");}
  else if(v2==-2.7&&ptLow==6.5&&ptHigh==7.5){
  ws->factory("b_Bkg[0.6, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.5, 1e-6, 1.]");
  ws->factory("fDLIV[0.5, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.2, 1e-6, 1.]");
  ws->factory("lambdaDF_Bkg[0.03, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.5, 1e-6, 1.]");}
  else if(v2==0&&ptLow==6.5&&ptHigh==7.5){
  ws->factory("b_Bkg[0.6, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.9, 1e-6, 1.]");
  ws->factory("fDLIV[0.1, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.1, 1e-6, 1.]");
  ws->factory("lambdaDF_Bkg[0.01, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.3, 1e-6, 1.]");}
  else if(v2==-0.3&&ptLow==6.5&&ptHigh==7.5){
  ws->factory("b_Bkg[0.6, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.88, 1e-6, 1.]");
  ws->factory("fDLIV[0.18, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.1, 1e-6, 1.]");
  ws->factory("lambdaDF_Bkg[0.01, 1e-6, 1.]");
  ...
  ws->factory("lambdaDF_Bkg[0.01, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.4, 1e-6, 1.]");}
  else if(v2==2.1&&ptLow==6.5&&ptHigh==7.5){
  ws->factory("b_Bkg[0.6, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.88, 1e-6, 1.]");
  ws->factory("fDLIV[0.18, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.1, 1e-6, 1.]");
  ...
  ws->factory("lambdaDSS_Bkg[0.5, 1e-6, 1.]");}
  else if(v2==-1.5&&ptLow==9&&ptHigh==12){
  ws->factory("b_Bkg[0.6, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.7, 1e-6, 1.]");
  ws->factory("fDLIV[0.3, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.05, 1e-6, 1.]");
  ws->factory("lambdaDF_Bkg[0.01, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.3, 1e-6, 1.]");}
  else if(v2==-1.8&&ptLow==12&&ptHigh==15){
  ws->factory("b_Bkg[0.6, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.7, 1e-6, 1.]");
  ws->factory("fDLIV[0.3, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.5, 1e-6, 1.]");
  ws->factory("lambdaDF_Bkg[0.01, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.4, 1e-6, 1.]");}
  else if(v2==-2.1&&ptLow==12&&ptHigh==15){
  ws->factory("b_Bkg[0.6, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.7, 1e-6, 1.]");
  ws->factory("fDLIV[0.8, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.1, 1e-6, 1.]");
  ws->factory("lambdaDF_Bkg[0.06, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.2, 1e-6, 1.]");}
  //else if(ptLow==15&&ptHigh==50){
  //ws->factory("b_Bkg[0.6, 1e-6, 1.]");//NP fraction for bkg
  //ws->factory("fDFSS[0.5, 1e-6, 1.]");
  //ws->factory("fDLIV[0.5, 1e-6, 1.]");
  //ws->factory("lambdaDDS_Bkg[0.17, 1e-6, 1.]");
  //ws->factory("lambdaDF_Bkg[0.03, 1e-6, 1.]");
  //ws->factory("lambdaDSS_Bkg[0.5, 1e-6, 1.]");}
  else if(v2==0.3&&ptLow==15&&ptHigh==50){
  ws->factory("b_Bkg[0.6, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.8, 1e-6, 1.]");
  ws->factory("fDLIV[0.7, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.4, 1e-6, 1.]");
  ws->factory("lambdaDF_Bkg[0.03, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.5, 1e-6, 1.]");}
  else if(v2==-0.6&&ptLow==15&&ptHigh==20){
  ws->factory("b_Bkg[0.6, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.4, 1e-6, 1.]");
  ws->factory("fDLIV[0.5, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.19, 1e-6, 1.]");
  ws->factory("lambdaDF_Bkg[0.04, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.2, 1e-6, 1.]");}
  else if(v2==1.2&&ptLow==15&&ptHigh==20){
  ws->factory("b_Bkg[0.6, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.4, 1e-6, 1.]");
  ws->factory("fDLIV[0.5, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.19, 1e-6, 1.]");
  ws->factory("lambdaDF_Bkg[0.01, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.2, 1e-6, 1.]");}
  else if(v2==1.5&&ptLow==15&&ptHigh==20){
  ws->factory("b_Bkg[0.6, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.4, 1e-6, 1.]");
  ws->factory("fDLIV[0.5, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.19, 1e-6, 1.]");
  ...
  ws->factory("lambdaDF_Bkg[0.04, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.2, 1e-6, 1.]");}
  else if(v2==-1.8&&ptLow==15&&ptHigh==20){
  ws->factory("b_Bkg[0.6, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.4, 1e-6, 1.]");
  ws->factory("fDLIV[0.5, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.19, 1e-6, 1.]");
  ws->factory("lambdaDF_Bkg[0.04, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.2, 1e-6, 1.]");}
  else if(v2==-2.1&&ptLow==15&&ptHigh==20){
  ws->factory("b_Bkg[0.6, 1e-6, 1.]");//NP fraction for bkg
  ...
  ws->factory("lambdaDF_Bkg[0.01, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.4, 1e-6, 1.]");}
  else if(v2==-2.7&&ptLow==20&&ptHigh==25){
  ws->factory("b_Bkg[0.6, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.8, 1e-6, 1.]");
  ws->factory("fDLIV[0.7, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.36, 1e-6, 1.]");
  ws->factory("lambdaDF_Bkg[0.03, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.38, 1e-6, 1.]");}
  else if(v2==-1.5&&ptLow==20&&ptHigh==50){
  ws->factory("b_Bkg[0.6, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.4, 1e-6, 1.]");
  ws->factory("fDLIV[0.5, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.19, 1e-6, 1.]");
  ws->factory("lambdaDF_Bkg[0.01, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.2, 1e-6, 1.]");}
  else if(v2==-1.8&&ptLow==20&&ptHigh==50){
  ws->factory("b_Bkg[0.6, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.5, 1e-6, 1.]");
  ws->factory("fDLIV[0.5, 1e-6, 1.]");
  ...
  ws->factory("lambdaDF_Bkg[0.03, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.5, 1e-6, 1.]");}
  else if(v2==-2.7&&ptLow==20&&ptHigh==50){
  ws->factory("b_Bkg[0.6, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.4, 1e-6, 1.]");
  ws->factory("fDLIV[0.5, 1e-6, 1.]");
  ...
  else if(v2==0.6&&ptLow==20&&ptHigh==50){
  ws->factory("b_Bkg[0.6, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.4, 1e-6, 1.]");
  ws->factory("fDLIV[0.5, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.6, 1e-6, 1.]");
  ws->factory("lambdaDF_Bkg[0.04, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.6, 1e-6, 1.]");}
  else if(v2==0.9&&ptLow==20&&ptHigh==50){
  ws->factory("b_Bkg[0.6, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.4, 1e-6, 1.]");
  ws->factory("fDLIV[0.5, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.6, 1e-6, 1.]");
  ws->factory("lambdaDF_Bkg[0.04, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.6, 1e-6, 1.]");}
  else if(v2==2.1&&ptLow==20&&ptHigh==50){
  ws->factory("b_Bkg[0.6, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.4, 1e-6, 1.]");
  ws->factory("fDLIV[0.5, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.4, 1e-6, 1.]");
  ws->factory("lambdaDF_Bkg[0.01, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.4, 1e-6, 1.]");}
  else if(v2==-1.8&&ptLow==25&&ptHigh==50){
  ws->factory("b_Bkg[0.6, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.5, 1e-6, 1.]");
  ws->factory("fDLIV[0.5, 1e-6, 1.]");
  ...
  ws->factory("lambdaDSS_Bkg[0.4, 1e-6, 1.]");}
  else if(v2==0&&ptLow==25&&ptHigh==50){
  ws->factory("b_Bkg[0.6, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.5, 1e-6, 1.]");
  ws->factory("fDLIV[0.5, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.29, 1e-6, 1.]");
  ws->factory("lambdaDF_Bkg[0.1, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.4, 1e-6, 1.]");}
  else if(ptLow==6.5&&ptHigh==50&&cLow==20&&cHigh==40){
  ...
  ws->factory("lambdaDF_Bkg[0.3, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.5, 1e-6, 1.]");}
  else if(v2==1.8&&cLow==0&&cHigh==20){
  ws->factory("b_Bkg[0.2, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.5, 1e-6, 1.]");
  ws->factory("fDLIV[0.5, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.07, 1e-6, 1.]");
  ws->factory("lambdaDF_Bkg[0.5, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.37, 1e-6, 1.]");}
  else if(v2==-1.5&&cLow==40&&cHigh==60){
  ws->factory("b_Bkg[0.2, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.5, 1e-6, 1.]");
  ws->factory("fDLIV[0.5, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.1, 1e-6, 1.]");
  ws->factory("lambdaDF_Bkg[0.06, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.4, 1e-6, 1.]");}
  else if(v2==-2.1&&cLow==40&&cHigh==60){
  ws->factory("b_Bkg[0.2, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.5, 1e-6, 1.]");
  ws->factory("fDLIV[0.5, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.1, 1e-6, 1.]");
  ws->factory("lambdaDF_Bkg[0.06, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.4, 1e-6, 1.]");}
  else if(v2==1.2&&cLow==40&&cHigh==60){
  ws->factory("b_Bkg[0.2, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.5, 1e-6, 1.]");
  ws->factory("fDLIV[0.5, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.1, 1e-6, 1.]");
  ws->factory("lambdaDF_Bkg[0.06, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.4, 1e-6, 1.]");}
  else if(v2==1.8&&cLow==40&&cHigh==60){
  ws->factory("b_Bkg[0.2, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.3, 1e-6, 1.]");
  ws->factory("fDLIV[0.5, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.3, 1e-6, 1.]");
  ws->factory("lambdaDF_Bkg[0.08, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.6, 1e-6, 1.]");}
  else if(v2==2.1&&cLow==40&&cHigh==60){
  ws->factory("b_Bkg[0.2, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.8, 1e-6, 1.]");
  ws->factory("fDLIV[0.9, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.4, 1e-6, 1.]");
  ws->factory("lambdaDF_Bkg[0.06, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.4, 1e-6, 1.]");}
  else if(v2==-1.8&&cLow==60&&cHigh==80){
  ws->factory("b_Bkg[0.2, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.9, 1e-6, 1.]");
  ws->factory("fDLIV[0.1, 1e-6, 1.]");
  ...
  ws->factory("lambdaDF_Bkg[0.5, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.6, 1e-6, 1.]");}
  else if(v2==-1.2&&cLow==60&&cHigh==80){
  ws->factory("b_Bkg[0.2, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.3, 1e-6, 1.]");
  ws->factory("fDLIV[0.5, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.3, 1e-6, 1.]");
  ...
  ws->factory("lambdaDF_Bkg[0.03, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.6, 1e-6, 1.]");}
  else if(v2==-1.2&&cLow==80&&cHigh==100){
  ws->factory("b_Bkg[0.2, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.3, 1e-6, 1.]");
  ws->factory("fDLIV[0.5, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.2, 1e-6, 1.]");
  ws->factory("lambdaDF_Bkg[0.2, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.5, 1e-6, 1.]");}
  else if(v2==-1.8&&cLow==80&&cHigh==100){
  ws->factory("b_Bkg[0.2, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.6, 1e-6, 1.]");
  ws->factory("fDLIV[0.7, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.35, 1e-6, 1.]");
  ws->factory("lambdaDF_Bkg[0.1, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.5, 1e-6, 1.]");}
  else if(v2==0&&cLow==80&&cHigh==100){
  ws->factory("b_Bkg[0.2, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.8, 1e-6, 1.]");
  ws->factory("fDLIV[0.5, 1e-6, 1.]");
  ...
  ws->factory("lambdaDSS_Bkg[0.5, 1e-6, 1.]");}
  else if(v2==0.3&&cLow==80&&cHigh==100){
  ws->factory("b_Bkg[0.2, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.5, 1e-6, 1.]");
  ws->factory("fDLIV[0.6, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.1, 1e-6, 1.]");
  ws->factory("lambdaDF_Bkg[0.05, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.5, 1e-6, 1.]");}
  else if(v2==-2.1&&cLow==100&&cHigh==180){
  ws->factory("b_Bkg[0.2, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.8, 1e-6, 1.]");
  ws->factory("fDLIV[0.5, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.02, 1e-6, 1.]");
  ws->factory("lambdaDF_Bkg[0.5, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.5, 1e-6, 1.]");}
  else if(v2==1.5&&cLow==100&&cHigh==180){
  ws->factory("b_Bkg[0.2, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.8, 1e-6, 1.]");
  ws->factory("fDLIV[0.5, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.3, 1e-6, 1.]");
  ws->factory("lambdaDF_Bkg[0.01, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.2, 1e-6, 1.]");}
  else if(v2==1.8&&cLow==100&&cHigh==180){
  ws->factory("b_Bkg[0.2, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.8, 1e-6, 1.]");
  ws->factory("fDLIV[0.5, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.03, 1e-6, 1.]");
  ws->factory("lambdaDF_Bkg[0.07, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.6, 1e-6, 1.]");}
/*
  else if(v2==2.1&&ptLow==6.5&&ptHigh==7.5){
  ws->factory("b_Bkg[0.6, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.3, 1e-6, .99]");
  ws->factory("fDLIV[0.23, 1e-6, .99]");
  ws->factory("lambdaDDS_Bkg[0.2, 1e-6, 1.]");
  ws->factory("lambdaDF_Bkg[0.1, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.1, 1e-6, 1.]");}
  else if(v2==-0.9&&ptLow==6.5&&ptHigh==7.5){
  ws->factory("b_Bkg[0.6, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.3, 1e-6, .99]");
  ws->factory("fDLIV[0.23, 1e-6, .99]");
  ws->factory("lambdaDDS_Bkg[0.2, 1e-6, 1.]");
  ws->factory("lambdaDF_Bkg[0.1, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.1, 1e-6, 1.]");}
  else if(v2==-1.2&&ptLow==6.5&&ptHigh==7.5){
  ws->factory("b_Bkg[0.6, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.3, 1e-6, .99]");
  ws->factory("fDLIV[0.23, 1e-6, .99]");
  ws->factory("lambdaDDS_Bkg[0.2, 1e-6, 1.]");
  ws->factory("lambdaDF_Bkg[0.1, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.1, 1e-6, 1.]");}
  else if(v2==-1.8&&ptLow==6.5&&ptHigh==7.5){
  ws->factory("b_Bkg[0.6, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.3, 1e-6, .99]");
  ws->factory("fDLIV[0.23, 1e-6, .99]");
  ws->factory("lambdaDDS_Bkg[0.2, 1e-6, 1.]");
  ...
  ws->factory("lambdaDDS_Bkg[0.4, 1e-6, 1.]");
  ws->factory("lambdaDF_Bkg[0.05, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.09, 1e-6, 1.]");}
  else if(v2==0&&ptLow==6.5&&ptHigh==7.5){
	  cout << " HERE " << endl;
  ws->factory("b_Bkg[0.5, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.6, 1e-6, 1.]");
  ...
  ws->factory("lambdaDF_Bkg[0.3, 0.1, 1.]");
  ws->factory("lambdaDSS_Bkg[0.5, 1e-6, 1.]");}
  else if(v2==-0.9&&ptLow==7.5&&ptHigh==9){
  ws->factory("b_Bkg[0.6, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.5, 1e-6, 1.]");
  ws->factory("fDLIV[0.5, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.2, 0.0, 1.]");
  ws->factory("lambdaDF_Bkg[0.3, 0.1, 1.]");
  ws->factory("lambdaDSS_Bkg[0.5, 1e-6, 1.]");}
  else if(v2==-1.8&&ptLow==7.5&&ptHigh==9){
	  cout << "HERE" << endl;
  ws->factory("b_Bkg[0.6, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.5, 1e-6, 1.]");
  ws->factory("fDLIV[0.5, 1e-6, 1.]");
  ...
  ws->factory("lambdaDSS_Bkg[0.5, 1e-6, 1.]");}
  else if(v2==-2.4&&ptLow==7.5&&ptHigh==9){
  ws->factory("b_Bkg[0.6, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.5, 1e-6, 1.]");
  ws->factory("fDLIV[0.5, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.2, 0.0, 1.]");
  ws->factory("lambdaDF_Bkg[0.02, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.5, 1e-6, 1.]");}
  else if(v2==1.5&&ptLow==7.5&&ptHigh==9){
  ws->factory("b_Bkg[0.6, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.5, 1e-6, 1.]");
  ws->factory("fDLIV[0.5, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.3, 1e-6, 1.]");
  ...
  ws->factory("lambdaDF_Bkg[0.3, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.5, 1e-6, 1.]");}
  else if(ptLow==12&&ptHigh==15&&cLow==20&&cHigh==120){
  ws->factory("b_Bkg[0.7306, 1e-6, 0.7306]");//NP fraction for bkg
  ws->factory("fDFSS[0.9002, 1e-6, 0.9002]");
  ws->factory("fDLIV[0.8437, 1e-6, 0.837]");
  ws->factory("lambdaDDS_Bkg[0.0941, 1e-6, 1.]");
  ws->factory("lambdaDF_Bkg[1e-6, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.3973, 1e-6, 1.]");}
  else if(ptLow==12&&ptHigh==15&&cLow==40&&cHigh==80){
  ws->factory("b_Bkg[0.7306, 1e-6, 0.7306]");//NP fraction for bkg
  ws->factory("fDFSS[0.9002, 1e-6, 0.9002]");
  ws->factory("fDLIV[0.8437, 1e-6, 0.837]");
  ws->factory("lambdaDDS_Bkg[0.0941, 1e-6, 1.]");
  ...
  ws->factory("lambdaDSS_Bkg[0.3973, 1e-6, 1.]");}
  //else if(ptLow==12&&ptHigh==15&&cLow==20&&cHigh==120){
  //ws->factory("b_Bkg[0.7306, 1e-6, 1.0]");//NP fraction for bkg
  //ws->factory("fDFSS[0.9002, 1e-6, 1.0]");
  //ws->factory("fDLIV[0.8437, 1e-6, 1.0]");
  //ws->factory("lambdaDDS_Bkg[0.0941, 1e-6, 1.]");
  //ws->factory("lambdaDF_Bkg[1e-6, 1e-6, 1.]");
  //ws->factory("lambdaDSS_Bkg[0.3973, 1e-6, 1.]");}
  else if(ptLow==12&&ptHigh==50){
  ws->factory("b_Bkg[0.9815, 0., 1.]");//NP fraction for bkg
  ws->factory("fDFSS[1, 1e-6, 1.]");
  ws->factory("fDLIV[1, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.2, 1e-6, 1.]");
  ws->factory("lambdaDF_Bkg[0.9, 0.1, 1.]");
  ws->factory("lambdaDSS_Bkg[0.5, 1e-6, 1.]");}
  else if(ptLow==15&&ptHigh==50&&cLow==20&&cHigh==120){
	  cout << "++++++++++++++++++++++ HERE ++++++++++++++++++++++" << endl;
  ws->factory("b_Bkg[0.1, 0., 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.5, 1e-6, 1.]");
  ws->factory("fDLIV[0.3, 1e-6, 1.]");
  ...
  ws->factory("lambdaDF_Bkg[0.3, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.5, 1e-6, 1.]");}
  else if(ptLow==15&&ptHigh==50&&cLow==40&&cHigh==80){
  ...
  ws->factory("lambdaDF_Bkg[0.3, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.5, 1e-6, 1.]");}
  else if(ptLow==6.5&&ptHigh==50&&cLow==0&&cHigh==20){
  ws->factory("b_Bkg[0.4, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.5, 1e-6, 1.]");
  ws->factory("fDLIV[0.5, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.2, 1e-6, 1.]");
  ws->factory("lambdaDF_Bkg[0.3, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.5, 1e-6, 1.]");}
  else if(ptLow==6.5&&ptHigh==50&&cLow==80&&cHigh==100){
  ws->factory("b_Bkg[0.2, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.5, 1e-6, 1.]");
  ws->factory("fDLIV[0.5, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.2, 1e-6, 1.]");
  ...
  if(v2==2.1&&ptLow==6.5&&ptHigh==7.5) { ctauMin=-1.; ctauMax=2.5;}
  else if(v2==1.8&&ptLow==4.5&&ptHigh==6.5){ ctauMax=1.5; }
  else if(v2==-2.1&&ptLow==3&&ptHigh==6.5){ ctauMin=-1; ctauMax=2; }

  else if(v2==-1.2&&ptLow==15&&ptHigh==50) { ctauMin=-1; ctauMax=1.5; }
  else if(v2==-2.1&&ptLow==15&&ptHigh==50) { ctauMin=-1; }
  else if(v2==-0.9&&ptLow==15&&ptHigh==50) { ctauMin=-1; }
  else if(v2==-1.2&&ptLow==6.5&&ptHigh==7.5) { ctauMin=-1; }
  else if(v2==-1.8&ptLow==6.5&&ptHigh==7.5) { ctauMax=1.5; }
  else if(v2==-0.3&ptLow==6.5&&ptHigh==7.5) { ctauMin=-1.; ctauMax=2.8; }
  else if(v2==0&ptLow==6.5&&ptHigh==7.5) { ctauMin=-1; ctauMax=2.2;}
  else if(v2==-2.7&ptLow==6.5&&ptHigh==7.5) { ctauMin=-1; ctauMax=1.5; }
  else if(v2==-0.9&ptLow==7.5&&ptHigh==9) { ctauMin=-1; }
  else if(v2==-1.8&ptLow==7.5&&ptHigh==9) { ctauMin=-1.; ctauMax=1.2; }
  else if(v2==-1.5&ptLow==7.5&&ptHigh==9) { ctauMin=-1.;ctauMax=2; }
  else if(v2==-2.1&ptLow==7.5&&ptHigh==9) { ctauMin=-1.; }
  else if(v2==-2.4&ptLow==7.5&&ptHigh==9) { ctauMin=-1.; }
  else if(v2==0.3&&ptLow==7.5&&ptHigh==9) { ctauMin=-1; ctauMax=1.44; }
  else if(v2==1.5&&ptLow==7.5&&ptHigh==9) { ctauMin=-1; ctauMax=1.16; }
  else if(v2==-1.5&&ptLow==15&&ptHigh==50){ ctauMin=-1.; }
  else if(v2==0.3&&ptLow==15&&ptHigh==50){ ctauMin=-1.; }

  else if(v2==-2.7&&ptLow==6.5&&ptHigh==9) { ctauMin=-0.55; ctauMax=1.05;}
  else if(v2==2.1&&ptLow==6.5&&ptHigh==9) { ctauMin=-1; ctauMax=1.;}

  else if(v2==2.1&&ptLow==9&&ptHigh==12) { ctauMin=-1; ctauMax=1.;}
  else if(v2==-1.5&&ptLow==9&&ptHigh==12) { ctauMin=-1;}

  else if(v2==-0.6&&ptLow==12&&ptHigh==15) { ctauMin=-1;}
  else if(v2==-0.9&&ptLow==12&&ptHigh==15) { ctauMin=-1;}
  else if(v2==-1.8&&ptLow==12&&ptHigh==15) { ctauMin=-1;}
  else if(v2==-2.1&&ptLow==12&&ptHigh==15) { ctauMin=-1;}

  else if(v2==-2.7&&ptLow==15&&ptHigh==20) { ctauMin=-1; ctauMax=1;}
  
  else if(v2==-2.7&&ptLow==20&&ptHigh==25) { ctauMin=-0.7; ctauMax=2;}
//  else if(v2==-1.8&&ptLow==25&&ptHigh==50) ctauMax=1.;

  else if (v2==-0.3&&cLow==0&&cHigh==20) {ctauMin=-1;}
  else if (v2==-1.8&&cLow==0&&cHigh==20) {ctauMin=-1;}
  else if (v2==-2.7&&cLow==0&&cHigh==20) {ctauMin=-1;}
  else if (v2==-2.1&&cLow==0&&cHigh==20){ ctauMin=-1.; }
  else if (v2==0.6&&cLow==0&&cHigh==20) {ctauMin=-1.05;}
  else if (v2==1.8&&cLow==0&&cHigh==20){ ctauMin=-0.7; ctauMax=2.;}
  else if (v2==2.1&&cLow==0&&cHigh==20){ ctauMin=-1.; }

  else if (v2==-2.7&&cLow==20&&cHigh==40) {ctauMin=-1.;}
  else if (v2==2.1&&cLow==20&&cHigh==40) {ctauMin=-1.;}

  else if (v2==-1.5&&cLow==40&&cHigh==60) {ctauMin=-0.6; ctauMax=2.5;}
  else if (v2==-1.8&&cLow==40&&cHigh==60) {ctauMin=-0.6; ctauMax=1.4;}
  else if (v2==-2.1&&cLow==40&&cHigh==60) {ctauMin=-1; ctauMax=1; }
  else if (v2==1.8&&cLow==40&&cHigh==60) {ctauMin=-0.7; ctauMax=1.; }
  else if (v2==2.1&&cLow==40&&cHigh==60) {ctauMin=-0.5; ctauMax=1.; }

  else if (v2==-0.3&&cLow==60&&cHigh==80) {ctauMin=-1.;}
  else if (v2==0.6&&cLow==60&&cHigh==80) {ctauMin=-.6;}
  else if (v2==-1.2&&cLow==60&&cHigh==80) {ctauMin=-1.;ctauMax=2;}
  else if (v2==-1.5&&cLow==60&&cHigh==80) {ctauMin=-1.;ctauMax=2;}
  else if (v2==-1.8&&cLow==60&&cHigh==80) {ctauMin=-0.7;}
  else if (v2==0&&cLow==60&&cHigh==80) {ctauMin=-1.;}
  else if (v2==1.2&&cLow==60&&cHigh==80) {ctauMin=-1.;}
  else if (v2==1.8&&cLow==60&&cHigh==80) {ctauMin=-1.;}
  else if (v2==2.1&&cLow==60&&cHigh==80) {ctauMin=-1.; ctauMax=1.;}

  else if (v2==-0.6&&cLow==80&&cHigh==100) {ctauMin=-.7;}
  else if (v2==-0.9&&cLow==80&&cHigh==100) {ctauMin=-1.;ctauMax=2;}
  else if (v2==-1.5&&cLow==80&&cHigh==100) {ctauMin=-1.;}
  else if (v2==-1.8&&cLow==80&&cHigh==100) {ctauMin=-1.;}
  else if (v2==-2.1&&cLow==80&&cHigh==100) {ctauMin=-1.;ctauMax=1.5;}
  else if (v2==-2.7&&cLow==80&&cHigh==100) {ctauMin=-1.;}
  else if (v2==2.1&&cLow==80&&cHigh==100) {ctauMin=-1.;}
  else if (v2==0&&cLow==80&&cHigh==100) {ctauMin=-.7;}
  else if (v2==0.3&&cLow==80&&cHigh==100) {ctauMin=-1.;}
  else if (v2==1.5&&cLow==80&&cHigh==100) {ctauMin=-1.;}

  else if (v2==-1.5&&cLow==100&&cHigh==180) {ctauMin=-1.;}
//  else if (v2==-2.7&&cLow==100&&cHigh==180) {ctauMin=-.6;}
  else if (v2==0&&cLow==100&&cHigh==180) {ctauMin=-1; }
  else if (v2==1.5&&cLow==100&&cHigh==180) {ctauMin=-1; }
  else if (v2==1.8&&cLow==100&&cHigh==180) {ctauMin=-1; }
  else if (v2==-1.2&&cLow==100&&cHigh==180) {ctauMin=-1; }
  else if (v2==-0.9&&cLow==100&&cHigh==180) {ctauMax=1.7; ctauMin=-0.7; }
  else if (v2==-2.1&&cLow==100&&cHigh==180) { ctauMin=-0.6; }
  else if (v2==-2.7&&cLow==100&&cHigh==180) { ctauMin=-0.6; }

//  else if (ptLow==15 || ptLow==20) ctauMin=-1.;
  else if (v2==1.5&&ptLow==20&&ptHigh==50) {ctauMin=-1.; ctauMax=2;}
  else if (v2==2.1&&ptLow==20&&ptHigh==50) {ctauMin=-1.; ctauMax=3;}

  else if(ptLow==25 || ptLow==20) ctauMin=-1.;
...
//  RooDataSet* dataToFit = (RooDataSet*)dataw_Bkg->reduce(Form("ctau3D>=%.f&&ctau3D<=%.f",-2.0, 4.0))->Clone("dataw_Bkg");
  ...
  c_E->Update();
  c_E->SaveAs(Form("figs/2DFit_%s/CtauBkg_v2Bins/Bkg_%s_%sw_Effw%d_Accw%d_PtW%d_TnP%d_v2_%.2f.pdf", DATE.Data(), kineLabel.Data(), fname.Data(), fEffW, fAccW, isPtW, isTnP, v2));
  ...
  TFile *outFile = new TFile(Form("roots/2DFit_%s/CtauBkg_v2Bins/CtauBkgResult_%s_%sw_Effw%d_Accw%d_PtW%d_TnP%d_v2_%.2f.root", DATE.Data(), kineLabel.Data(), fname.Data(), fEffW, fAccW, isPtW, isTnP, v2),"recreate");
  fitCtauBkg->Write();
