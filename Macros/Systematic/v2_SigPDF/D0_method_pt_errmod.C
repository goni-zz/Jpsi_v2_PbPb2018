    ...
    )
{
  ...
  c1->SaveAs(Form("plot_D0method_%s_FreePar.png",kineLabel.Data()));
  c1->SaveAs(Form("plot_D0method_%s_FreePar.pdf",kineLabel.Data()));
  ...
  c2->SaveAs(Form("plot_D0method_bfractions_%s_FreePar.png",kineLabel.Data()));
  c2->SaveAs(Form("plot_D0method_bfractions_%s_FreePar.pdf",kineLabel.Data()));
