...
//  RooBinning bins(nBins, ctauErrLow, ctauErrHigh);
  ...
  else if(v2==1.8&&ptLow==3&&ptHigh==4.5) ctauErrMax=0.1023;
  ...
  else if(v2==-2.7&&ptLow==12&&ptHigh==15) ctauErrMax=0.0342;
...
//  else if(v2==-2.7&&cLow==20&&cHigh==40) ctauErrMax=0.0468;
  ...
  else if(v2==-1.8&&cLow==60&&cHigh==80) ctauErrMax=0.04608;
  ...
  else if(v2==-2.1&&cLow==80&&cHigh==100) ctauErrMin=0.0126;
