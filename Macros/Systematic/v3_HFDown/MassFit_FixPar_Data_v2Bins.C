    ...
    )
{
  ...
  f1 = new TFile(Form("../../../skimmedFiles/v3Cut_HFDown/OniaRooDataSet_isMC0_JPsi_%s_m2.6-3.5_OS_Effw%d_Accw%d_PtW%d_TnP%d_%s_220113.root",kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,DATE.Data()));
...
//  f1 = new TFile("/Users/hwan/tools/2019/CMS/JPsi/Jpsi_v2_PbPb2018/skimmedFiles/vnCut/OniaRooDataSet_isMC0_JPsi_pt3.0-4.5_y1.6-2.4_muPt0.0_centrality20-120_m2.6-3.5_OS_Effw0_Accw0_PtW1_TnP1_211110.root");
  ...
  RooRealVar *sl1 = new RooRealVar("sl1","sl1", 0.0, -2., 2.); // 15<pt<50 v2==-1.2 : 0.01
  RooRealVar *sl2 = new RooRealVar("sl2","sl2", 0.0, -2., 2.);
  RooRealVar *sl3 = new RooRealVar("sl3","sl3", 0.0, -2., 2.);
  RooRealVar *sl4 = new RooRealVar("sl4","sl4", 0.0, -2., 2.);
  RooRealVar *sl5 = new RooRealVar("sl5","sl5", 0.0, -2., 2.);
  RooRealVar *sl6 = new RooRealVar("sl6","sl6", 0.0, -2., 2.);
  ...
  if (ptLow==15&&ptHigh==50)  {
	  NBkg_limit = 1.0e+04;
	  NJpsi_limit = 1.0e+04; }
  else if (v2==0.9&&ptLow==3&&ptHigh==6.5){
	 NBkg_limit = 2.0e+06;
	 NJpsi_limit = 3.0e+05;  }
      ...
      NBkg_limit = 2.0e+04;
      NJpsi_limit = 4.0e+04; }
  else if (v2==-1.8&&ptLow==9&&ptHigh==12)  {
	  cout << "HERE" << endl;
      NBkg_limit = 4.0e+03;
      NJpsi_limit = 1.0e+04; }
