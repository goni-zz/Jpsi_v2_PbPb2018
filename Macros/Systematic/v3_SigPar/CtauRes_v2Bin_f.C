    ...
    )
{
  ...
  if(ptLow==6.5&&ptHigh==9&&cLow==20&&cHigh==120){
    ...
    ws->factory("s1_CtauRes[0.3, 1e-3, 2.0]");
    ...
    ws->factory("rS21_CtauRes[1.5, 1.0, 5.0]");
    ws->factory("rS32_CtauRes[2.5, 1.0, 5.0]");}
    //ws->factory("s1_CtauRes[0.11, 1e-3, 1.0]");
    //ws->factory("rS21_CtauRes[1.0, 1.0, 1.4]");
    //ws->factory("rS32_CtauRes[2.5, 1.0, 5.0]");}
    ...
    ws->factory("s1_CtauRes[0.4, 0., 1.0]");
    ws->factory("rS21_CtauRes[1.2, 1.0, 1.5]");
    ws->factory("rS32_CtauRes[2.5, 1.0, 5.0]");}
