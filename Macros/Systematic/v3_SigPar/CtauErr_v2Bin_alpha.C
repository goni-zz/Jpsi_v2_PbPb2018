    ...
    )
{
  ...
  gSystem->mkdir(Form("roots/2DFit_%s/CtauErr_v2Bins_alpha",DATE.Data()),kTRUE);
  gSystem->mkdir(Form("figs/2DFit_%s/CtauErr_v2Bins_alpha",DATE.Data()),kTRUE);
...
//  RooBinning bins(nBins, ctauErrLow, ctauErrHigh);
  ...
  if(cLow==0 && cHigh==40 && v2 == -0.3) ctauErrMax = 0.0882; 
  if(cLow==0 && cHigh==40 && v2 == 0.3) ctauErrMax = 0.0882; 
  if(cLow==0 && cHigh==40 && v2 == 2.4) ctauErrMax = 0.0704; 
  if(cLow==0 && cHigh==40 && v2 == 0.0) ctauErrMax = 0.0860; 
  if(cLow==0 && cHigh==40 && v2 == 1.2) ctauErrMax = 0.0852; 
  if(cLow==0 && cHigh==40 && v2 == 0.9) ctauErrMax = 0.0874; 
  if(cLow==0 && cHigh==40 && v2 == -1.5) ctauErrMax = 0.1052; 
  if(cLow==0 && cHigh==40 && v2 == 1.5) ctauErrMax = 0.0835; 
  if(cLow==0 && cHigh==40 && v2 == -1.8) ctauErrMax = 0.0818; 
  if(cLow==0 && cHigh==40 && v2 == 1.8) ctauErrMax = 0.1032; 
  if(cLow==0 && cHigh==40 && v2 == 2.1) ctauErrMax = 0.0762; 
  if(cLow==0 && cHigh==40 && v2 == -2.7) ctauErrMax = 0.0851; //0.1076; 
  if(cLow==40 && cHigh==80 && v2 == -0.6) ctauErrMax = 0.09; 
  if(cLow==40 && cHigh==80 && v2 == 0.6) ctauErrMax = 0.0906; 
  if(cLow==40 && cHigh==80 && v2 == -0.9) ctauErrMax = 0.0874; 
  if(cLow==40 && cHigh==80 && v2 == 0.9) ctauErrMax = 0.0828; 
  if(cLow==40 && cHigh==80 && v2 == -1.2) ctauErrMax = 0.0936; 
  if(cLow==40 && cHigh==80 && v2 == 1.5) ctauErrMax = 0.0848; 
  if(cLow==40 && cHigh==80 && v2 == -1.5) ctauErrMax = 0.1076; 
  if(cLow==40 && cHigh==80 && v2 == 1.8) ctauErrMax = 0.0745; 
  if(cLow==40 && cHigh==80 && v2 == -1.8) ctauErrMax = 0.0880; 
  if(cLow==40 && cHigh==80 && v2 == 2.1) ctauErrMax = 0.0860; 
  if(cLow==40 && cHigh==80 && v2 == -2.7) ctauErrMax = 0.0812; 
  if(cLow==40 && cHigh==80 && v2 == 0.0) ctauErrMax = 0.0886; 
  if(cLow==40 && cHigh==80 && v2 == 1.2) ctauErrMax = 0.0854; 
  if(cLow==40 && cHigh==80 && v2 == 2.1) ctauErrMax = 0.0727; 
  if(cLow==80 && cHigh==180 && v2 == 0.6) ctauErrMax = 0.0770; 
  if(cLow==80 && cHigh==180 && v2 == -0.3) ctauErrMax = 0.0756; 
  if(cLow==80 && cHigh==180 && v2 == 0.3) ctauErrMax = 0.0700; 
  if(cLow==80 && cHigh==180 && v2 == -0.6) ctauErrMax = 0.0792; 
  if(cLow==80 && cHigh==180 && v2 == -0.9) ctauErrMax = 0.0726; 
  if(cLow==80 && cHigh==180 && v2 == -1.8) ctauErrMax = 0.0722; 
  if(cLow==80 && cHigh==180 && v2 == -1.5) ctauErrMax = 0.069; 
  if(cLow==80 && cHigh==180 && v2 == -1.2) ctauErrMax = 0.0747; 
  if(cLow==80 && cHigh==180 && v2 == 1.2) ctauErrMin = 0.0109; 
  if(cLow==80 && cHigh==180 && v2 == -2.7) ctauErrMax = 0.0623; 
  if(cLow==80 && cHigh==180 && v2 == 2.1) ctauErrMax = 0.0748; 
  if(cLow==80 && cHigh==180 && v2 == 2.4) ctauErrMax = 0.0701; 

  if(cLow==20 && cHigh==120 && ptLow == 3.0 && ptHigh == 6.5 && v2 == -0.3) ctauErrMax = 0.1345; 
  if(cLow==20 && cHigh==120 && ptLow == 3.0 && ptHigh == 6.5 && v2 == -0.6) ctauErrMax = 0.1368; 
  if(cLow==20 && cHigh==120 && ptLow == 3.0 && ptHigh == 6.5 && v2 == -1.2) ctauErrMax = 0.135; 
  if(cLow==20 && cHigh==120 && ptLow == 3.0 && ptHigh == 6.5 && v2 == -1.5) ctauErrMax = 0.1292; 
  if(cLow==20 && cHigh==120 && ptLow == 3.0 && ptHigh == 6.5 && v2 == 0.0) ctauErrMax = 0.1198; 
  if(cLow==20 && cHigh==120 && ptLow == 3.0 && ptHigh == 6.5 && v2 == 1.8) ctauErrMax = 0.1206; 
  if(cLow==20 && cHigh==120 && ptLow == 3.0 && ptHigh == 6.5 && v2 == -2.1) ctauErrMax = 0.132; 
  if(cLow==20 && cHigh==120 && ptLow == 6.5 && ptHigh == 9.0 && v2 == 0.) ctauErrMax = 0.1116; 
  if(cLow==20 && cHigh==120 && ptLow == 6.5 && ptHigh == 9.0 && v2 == 0.3) ctauErrMax = 0.1054; 
  if(cLow==20 && cHigh==120 && ptLow == 6.5 && ptHigh == 9.0 && v2 == 1.2) ctauErrMax = 0.0972; 
  if(cLow==20 && cHigh==120 && ptLow == 6.5 && ptHigh == 9.0 && v2 == 1.5) ctauErrMax = 0.099; 
  if(cLow==20 && cHigh==120 && ptLow == 6.5 && ptHigh == 9.0 && v2 == 2.1) ctauErrMax = 0.0954; 
  if(cLow==20 && cHigh==120 && ptLow == 9.0 && ptHigh == 12.0 && v2 == 0.0) ctauErrMax = 0.0798; 
  if(cLow==20 && cHigh==120 && ptLow == 9.0 && ptHigh == 12.0 && v2 == -0.3) ctauErrMax = 0.092; 
  if(cLow==20 && cHigh==120 && ptLow == 9.0 && ptHigh == 12.0 && v2 == -0.6) ctauErrMax = 0.0684; 
  if(cLow==20 && cHigh==120 && ptLow == 9.0 && ptHigh == 12.0 && v2 == -1.2) ctauErrMax = 0.079; 
  if(cLow==20 && cHigh==120 && ptLow == 9.0 && ptHigh == 12.0 && v2 == 2.1) ctauErrMax = 0.0704; 
  if(cLow==20 && cHigh==120 && ptLow == 9.0 && ptHigh == 12.0 && v2 == -2.1) ctauErrMax = 0.0700; 
  if(cLow==20 && cHigh==120 && ptLow == 9.0 && ptHigh == 12.0 && v2 == -2.7) ctauErrMax = 0.0648; 


  if(cLow==20 && cHigh==120 && ptLow == 12.0 && ptHigh == 15.0 && v2 == -0.9) ctauErrMax = 0.0504; 
  if(cLow==20 && cHigh==120 && ptLow == 12.0 && ptHigh == 15.0 && v2 == -1.5) ctauErrMax = 0.0612; 
  if(cLow==20 && cHigh==120 && ptLow == 12.0 && ptHigh == 15.0 && v2 == 0.0) ctauErrMax = 0.0700; 
  if(cLow==20 && cHigh==120 && ptLow == 12.0 && ptHigh == 15.0 && v2 == 0.6) ctauErrMax = 0.0588; 
  if(cLow==20 && cHigh==120 && ptLow == 15.0 && ptHigh == 50.0 && v2 == 1.8) ctauErrMax = 0.0440; 
  //if(cLow==20 && cHigh==120 && ptLow == 12.0 && ptHigh == 15.0 && v2 == 1.2) ctauErrMax = 0.0900; 
  ...
  if(v2==2.1) drawText(Form("%.1f < v_{3} < %.1f",v2,v2+0.6),text_x+0.5,text_y-y_diff*5,text_color,text_size);
  else if(v2==-2.7) drawText(Form("%.1f < v_{3} < %.1f",v2,v2+0.6),text_x+0.5,text_y-y_diff*5,text_color,text_size);
  else drawText(Form("%.1f < v_{3} < %.1f",v2,v2+0.3),text_x+0.5,text_y-y_diff*5,text_color,text_size);
  ...
  c_B->Update();
  c_B->SaveAs(Form("figs/2DFit_%s/CtauErr_v2Bins_alpha/ctauErr_%s_%sw_Effw%d_Accw%d_PtW%d_TnP%d_v2_%.2f.pdf", DATE.Data(), kineLabel.Data(), fname.Data(), fEffW, fAccW, isPtW, isTnP, v2));

  TFile *outFile = new TFile(Form("roots/2DFit_%s/CtauErr_v2Bins_alpha/CtauErrResult_%s_%sw_Effw%d_Accw%d_PtW%d_TnP%d_v2_%.2f.root", DATE.Data(), kineLabel.Data(), fname.Data(), fEffW, fAccW, isPtW, isTnP, v2),"recreate");
  dataw_Bkg->Write();
  dataw_Sig->Write();
