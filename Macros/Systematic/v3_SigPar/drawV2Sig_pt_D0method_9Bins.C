...
void drawV2Sig_pt_D0method_9Bins(){
  ...
  const int nPtBins=9;
  float ptBin[nPtBins+1]={3,4.5,6.5,7.5,9,12,15,20,25,50};
  ...
  TFile *fPt7 = new TFile("v2_D0method_pt15.0-20.0_y0.0-2.4_muPt0.0_centrality20-120.root","read");
  TFile *fPt8 = new TFile("v2_D0method_pt20.0-25.0_y0.0-2.4_muPt0.0_centrality20-120.root","read");
  TFile *fPt9 = new TFile("v2_D0method_pt25.0-50.0_y0.0-2.4_muPt0.0_centrality20-120.root","read");

  /*
  TFile *fNP1 = new TFile("v2_D0method_pt3.0-4.5_y1.6-2.4_muPt0.0_centrality20-120.root","read");
  TFile *fNP2 = new TFile("v2_D0method_pt4.5-6.5_y1.6-2.4_muPt0.0_centrality20-120.root","read");
  TFile *fNP3 = new TFile("v2_D0method_pt6.5-7.5_y0.0-2.4_muPt0.0_centrality20-120.root","read");
  TFile *fNP4 = new TFile("v2_D0method_pt7.5-9.0_y0.0-2.4_muPt0.0_centrality20-120.root","read");
  TFile *fNP5 = new TFile("v2_D0method_pt9.0-12.0_y0.0-2.4_muPt0.0_centrality20-120.root","read");
  TFile *fNP6 = new TFile("v2_D0method_pt12.0-15.0_y0.0-2.4_muPt0.0_centrality20-120.root","read");
  TFile *fNP7 = new TFile("v2_D0method_pt15.0-20.0_y0.0-2.4_muPt0.0_centrality20-120.root","read");
  TFile *fNP8 = new TFile("v2_D0method_pt20.0-50.0_y0.0-2.4_muPt0.0_centrality20-120.root","read");
  */
  // 9 bins
  TFile *fNP1 = new TFile("v2_D0method_pt3.0-4.5_y1.6-2.4_muPt0.0_centrality20-120.root","read");
  TFile *fNP2 = new TFile("v2_D0method_pt4.5-6.5_y1.6-2.4_muPt0.0_centrality20-120.root","read");
  ...
  TFile *fNP6 = new TFile("v2_D0method_pt12.0-15.0_y0.0-2.4_muPt0.0_centrality20-120.root","read");
  TFile *fNP7 = new TFile("v2_D0method_pt15.0-20.0_y0.0-2.4_muPt0.0_centrality20-120.root","read");
  TFile *fNP8 = new TFile("v2_D0method_pt20.0-25.0_y0.0-2.4_muPt0.0_centrality20-120.root","read");
  TFile *fNP9 = new TFile("v2_D0method_pt25.0-50.0_y0.0-2.4_muPt0.0_centrality20-120.root","read");
  ...
  TH1D * PR6 = (TH1D*) fPt6 -> Get("hOutPR"); 
  TH1D * PR7 = (TH1D*) fPt7 -> Get("hOutPR"); 
  TH1D * PR8 = (TH1D*) fPt8 -> Get("hOutPR"); 
  TH1D * PR9 = (TH1D*) fPt9 -> Get("hOutPR"); 

  TH1D * NP1 = (TH1D*) fNP1 -> Get("hOutNP"); 
  TH1D * NP2 = (TH1D*) fNP2 -> Get("hOutNP"); 
  TH1D * NP3 = (TH1D*) fNP3 -> Get("hOutNP"); 
  TH1D * NP4 = (TH1D*) fNP4 -> Get("hOutNP"); 
  TH1D * NP5 = (TH1D*) fNP5 -> Get("hOutNP"); 
  TH1D * NP6 = (TH1D*) fNP6 -> Get("hOutNP"); 
  TH1D * NP7 = (TH1D*) fNP7 -> Get("hOutNP"); 
  TH1D * NP8 = (TH1D*) fNP8 -> Get("hOutNP"); 
  TH1D * NP9 = (TH1D*) fNP9 -> Get("hOutNP"); 

  double xPRpt1, yPRpt1, xPRpt2, yPRpt2, xPRpt3, yPRpt3, xPRpt4, yPRpt4, xPRpt5, yPRpt5, xPRpt6, yPRpt6, xPRpt7, yPRpt7, yPRpt8, yPRpt9;
  double xPRpt1Err, yPRpt1Err, xPRpt2Err, yPRpt2Err, xPRpt3Err, yPRpt3Err, xPRpt4Err, yPRpt4Err, xPRpt5Err, yPRpt5Err, xPRpt6Err, yPRpt6Err, xPRpt7Err, yPRpt7Err, yPRpt8Err, yPRpt9Err;
  ...
  yPRpt6= PR6->GetBinContent(0);
  yPRpt7= PR7->GetBinContent(0);
  yPRpt8= PR8->GetBinContent(0);
  yPRpt9= PR9->GetBinContent(0);
  ...
  yPRpt6Err= PR6->GetBinError(0);
  yPRpt7Err= PR7->GetBinError(0);
  yPRpt8Err= PR8->GetBinError(0);
  yPRpt9Err= PR9->GetBinError(0);
  ...
  gPR->SetPoint(4,(ptBin[6]+ptBin[7])/2,yPRpt7);
  gPR->SetPointError(4,0,yPRpt7Err);
  gPR->SetPoint(5,(ptBin[7]+ptBin[8])/2,yPRpt8);
  gPR->SetPointError(5,0,yPRpt8Err);
  gPR->SetPoint(6,(ptBin[8]+ptBin[9])/2,yPRpt9);
  gPR->SetPointError(6,0,yPRpt9Err);

  double xNPpt1, yNPpt1, xNPpt2, yNPpt2, xNPpt3, yNPpt3, xNPpt4, yNPpt4, xNPpt5, yNPpt5, xNPpt6, yNPpt6, xNPpt7, yNPpt7, yNPpt8, yNPpt9;
  double xNPpt1Err, yNPpt1Err, xNPpt2Err, yNPpt2Err, xNPpt3Err, yNPpt3Err, xNPpt4Err, yNPpt4Err, xNPpt5Err, yNPpt5Err, xNPpt6Err, yNPpt6Err, xNPpt7Err, yNPpt7Err, yNPpt8Err, yNPpt9Err;
 
  yNPpt1= NP1->GetBinContent(0); //3-4.5
  yNPpt2= NP2->GetBinContent(0); //4.5-6.5
  yNPpt3= NP3->GetBinContent(0); //6.5-7.5
  yNPpt4= NP4->GetBinContent(0); //7.5-9
  yNPpt5= NP5->GetBinContent(0); //9-12
  yNPpt6= NP6->GetBinContent(0); //9-12
  yNPpt7= NP7->GetBinContent(0); //9-12
  yNPpt8= NP8->GetBinContent(0); //9-12
  yNPpt9= NP9->GetBinContent(0); //9-12
  ...
  yNPpt8Err= NP8->GetBinError(0);
  yNPpt9Err= NP9->GetBinError(0);



  // ptBin[nPtBins+1]={3,4.5,6.5,7.5,9,12,15,50};
  // 3-6.5-7.5-9-12-15-50
  //gNPLow->SetPoint(0,(ptBin[0]+ptBin[2])/2,yNPpt8);
  //gNPLow->SetPointError(0,0,yNPpt8Err);
  ...
  //gNP->SetPoint(4,(ptBin[6]+ptBin[7])/2,yNPpt7);
  //gNP->SetPointError(4,0,yNPpt7Err);
  //gNP->SetPoint(5,(ptBin[7]+ptBin[9])/2,yNPpt8);
  //gNP->SetPointError(5,0,yNPpt8Err);

  // 3-4.5-6.5-7.5-9-12-15-20-25-50
  gNPLow->SetPoint(0,(ptBin[0]+ptBin[1])/2,yNPpt1);
  gNPLow->SetPointError(0,0,yNPpt1Err);
  gNPLow->SetPoint(1,(ptBin[1]+ptBin[2])/2,yNPpt2);
  gNPLow->SetPointError(1,0,yNPpt2Err);
  ...
  gNP->SetPoint(4,(ptBin[6]+ptBin[7])/2,yNPpt7);
  gNP->SetPointError(4,0,yNPpt7Err);
  gNP->SetPoint(5,(ptBin[7]+ptBin[8])/2,yNPpt8);
  gNP->SetPointError(5,0,yNPpt8Err);
  gNP->SetPoint(6,(ptBin[8]+ptBin[9])/2,yNPpt9);
  gNP->SetPointError(6,0,yNPpt9Err);
  // 3-6.5-9-12-15-50 {3,4.5,6.5,7.5,9,12,15,20,25,50};
  //gNPLow->SetPoint(0,(ptBin[0]+ptBin[2])/2,yNPpt1);
  //gNPLow->SetPointError(0,0,yNPpt1Err);
  //gNP->SetPoint(0,(ptBin[2]+ptBin[4])/2,yNPpt2);
  //gNP->SetPointError(0,0,yNPpt2Err);
  //gNP->SetPoint(1,(ptBin[4]+ptBin[5])/2,yNPpt3);
  //gNP->SetPointError(1,0,yNPpt3Err);
  //gNP->SetPoint(2,(ptBin[5]+ptBin[6])/2,yNPpt4);
  //gNP->SetPointError(2,0,yNPpt4Err);
  //gNP->SetPoint(3,(ptBin[6]+ptBin[9])/2,yNPpt4);
  //gNP->SetPointError(3,0,yNPpt4Err);
  ...
  c1->Update();
  c1->SaveAs(Form("new_v2_pT_9bins.pdf"));
  ...
  TFile *out = new TFile(Form("out_new_v2_vs_pT_9bins.root"),"recreate");
//  out->cd();
