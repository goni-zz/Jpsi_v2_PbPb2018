...
//            hNP->SetBinError(iv2+1,errprop_npr/2.0);
    ...
    c1->SaveAs(Form("./SigPar_x/plot_D0method_%s.png",kineLabel.Data()));
    c1->SaveAs(Form("./SigPar_x/plot_D0method_%s.pdf",kineLabel.Data()));
    ...
    c2->SaveAs(Form("./SigPar_x/plot_D0method_bfractions_%s.png",kineLabel.Data()));
    c2->SaveAs(Form("./SigPar_x/plot_D0method_bfractions_%s.pdf",kineLabel.Data()));
    ...
    TFile *outFile;
    outFile = new TFile(Form("./SigPar_x/v3_D0method_%s_x.root",kineLabel.Data()),"recreate");
    outFile->cd();
    hOutPR->Write();
    hOutNP->Write();
