    ...
    )
{
  ...
  ws->factory("lambdaDSS_Bkg[0.5, 1e-6, 1.]");}
  else if(v2==-2.1&&ptLow==6.5&&ptHigh==9){
	  cout << "HERE" << endl;
  ws->factory("b_Bkg[0.6, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.5, 1e-6, 1.]");
  ws->factory("fDLIV[0.5, 1e-6, 1.]");
  ...
  ws->factory("lambdaDF_Bkg[0.3, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.5, 1e-6, 1.]");}
  else if(ptLow==6.5&&ptHigh==50&&cLow==80&&cHigh==180){
  ...
  ws->factory("lambdaDF_Bkg[0.8, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg[0.4, 1e-6, 1.]");}
  else {
  ws->factory("b_Bkg[0.1, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.5, 1e-6, 1.]");
...
/*
  ws->factory("b_Bkg[0.01, 1e-6, 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.2, 1e-6, 1.]");
  ws->factory("fDLIV[0.3, 1e-6, 1.]");
  ws->factory("lambdaDDS_Bkg[0.1, 1e-6, 1.]");
  ws->factory("lambdaDF_Bkg[0.4, 1e-6, 1.]");
