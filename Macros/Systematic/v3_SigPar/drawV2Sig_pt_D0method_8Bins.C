...
void drawV2Sig_pt_D0method_8Bins(){
  ...
  const int nPtBins=8;
  float ptBin[nPtBins+1]={3,4.5,6.5,7.5,9,12,15,20,50};
  ...
  TFile *fPt8 = new TFile("v2_D0method_pt20.0-50.0_y0.0-2.4_muPt0.0_centrality20-120.root","read");
  TFile *fPt9 = new TFile("v2_D0method_pt3.0-6.5_y1.6-2.4_muPt0.0_centrality20-120.root","read");
  TFile *fPt10 = new TFile("v2_D0method_pt6.5-9.0_y0.0-2.4_muPt0.0_centrality20-120.root","read");
  ...
  TH1D * NP8 = (TH1D*) fPt8 -> Get("hOutNP"); //3-6.5 
  TH1D * NP9 = (TH1D*) fPt9 -> Get("hOutNP"); //6.5-9

  double xPRpt1, yPRpt1, xPRpt2, yPRpt2, xPRpt3, yPRpt3, xPRpt4, yPRpt4, xPRpt5, yPRpt5, xPRpt6, yPRpt6, xPRpt7, yPRpt7, yPRpt8;
  double xPRpt1Err, yPRpt1Err, xPRpt2Err, yPRpt2Err, xPRpt3Err, yPRpt3Err, xPRpt4Err, yPRpt4Err, xPRpt5Err, yPRpt5Err, xPRpt6Err, yPRpt6Err, xPRpt7Err, yPRpt7Err, yPRpt8Err;
  ...
  yNPpt6= NP6->GetBinContent(0); //12-15
  yNPpt7= NP7->GetBinContent(0); //15-50
  yNPpt8= NP8->GetBinContent(0); //3-6.5
  yNPpt9= NP9->GetBinContent(0); //6.5-9
  ...
  cout << "3-6.5	"   << yNPpt8 << " +/- " << yNPpt8Err << endl;
  cout << "6.5-9	"   << yNPpt9 << " +/- " << yNPpt9Err << endl;
  cout << "9-12	"       << yNPpt5 << " +/- " << yNPpt5Err << endl;
  cout << "12-15	"   << yNPpt6 << " +/- " << yNPpt6Err << endl;
  cout << "15-50	"   << yNPpt7 << " +/- " << yNPpt7Err << endl;
  ...
  //gNPLow->SetPoint(0,(ptBin[0]+ptBin[2])/2,yNPpt8);
  //gNPLow->SetPointError(0,0,yNPpt8Err);
  //gNP->SetPoint(0,(ptBin[2]+ptBin[4])/2,yNPpt9);
  //gNP->SetPointError(0,0,yNPpt9Err);
  //gNP->SetPoint(1,(ptBin[4]+ptBin[5])/2,yNPpt5);
  //gNP->SetPointError(1,0,yNPpt5Err);
  //gNP->SetPoint(2,(ptBin[5]+ptBin[6])/2,yNPpt6);
  //gNP->SetPointError(2,0,yNPpt6Err);
  //gNP->SetPoint(3,(ptBin[6]+ptBin[7])/2,yNPpt7);
  //gNP->SetPointError(3,0,yNPpt7Err);
  ...
  c1->Update();
  c1->SaveAs(Form("new_v2_pT_8bins.pdf"));
  ...
  TFile *out = new TFile(Form("out_new_v2_vs_pT_8bins.root"),"recreate");
//  out->cd();
