...
void MassFit_FixPar_Data_v2Bins_n(
    double v2=0,
    ...
    )
{
  ...
  gSystem->mkdir(Form("roots/2DFit_%s/Mass_v2Bins_n",DATE.Data()),kTRUE);
  gSystem->mkdir(Form("figs/2DFit_%s/Mass_v2Bins_n",DATE.Data()),kTRUE);
  ...
  f1 = new TFile(Form("../../../skimmedFiles/v3Cut_Nom/OniaRooDataSet_isMC0_JPsi_%s_m2.6-3.5_OS_Effw%d_Accw%d_PtW%d_TnP%d_%s_220113.root",kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,DATE.Data()));
...
//  f1 = new TFile("/Users/hwan/tools/2019/CMS/JPsi/Jpsi_v2_PbPb2018/skimmedFiles/vnCut/OniaRooDataSet_isMC0_JPsi_pt3.0-4.5_y1.6-2.4_muPt0.0_centrality20-120_m2.6-3.5_OS_Effw0_Accw0_PtW1_TnP1_211110.root");
  ...
  TFile * f_fit = new TFile(Form("../roots_MC_Root618_v2Final/Mass/MassFitResult_%s_PRw_Effw%d_Accw%d_PtW%d_TnP%d_test.root",kineLabel.Data(),fEffW,fAccW,isPtW,isTnP));
  ...
  if(v2==-0.3&&ptLow==3&&ptHigh==6.5) sigma_index=1;
  else if(v2==-0.9&&ptLow==3&&ptHigh==6.5) sigma_index=1;
  else if(v2==-1.5&&ptLow==3&&ptHigh==6.5) sigma_index=1;
  else if(v2==-2.1&&ptLow==3&&ptHigh==6.5) sigma_index=1;
  else if(v2==0&&ptLow==3&&ptHigh==6.5) sigma_index=1;
  else if(v2==0.3&&ptLow==3&&ptHigh==6.5) sigma_index=1;
  else if(v2==0.6&&ptLow==3&&ptHigh==6.5) sigma_index=3;
  else if(v2==0.9&&ptLow==3&&ptHigh==6.5) sigma_index=1;
  else if(v2==1.2&&ptLow==3&&ptHigh==6.5) sigma_index=1;
  else if(v2==1.5&&ptLow==3&&ptHigh==6.5) sigma_index=1;
  else if(v2==1.8&&ptLow==3&&ptHigh==6.5) sigma_index=1;
  else if(v2==2.1&&ptLow==3&&ptHigh==6.5) sigma_index=3;
 
  else if(v2==-0.6&&ptLow==6.5&&ptHigh==9) sigma_index=3;
  else if(v2==0&&ptLow==6.5&&ptHigh==9) sigma_index=3;

  else if(v2==0.6&&cLow==0&&cHigh==40) sigma_index=1;

  else if(v2==-0.3&&cLow==40&&cHigh==80) sigma_index=3;

  else if(v2==-0.9&&cLow==80&&cHigh==180) sigma_index=3;
  ...
  //double paramslower[6] = {1.1, 0.0, 0.00, 1.0, 0.0,  0.0};
  //double paramsupper[6] = {4.1, 5.0, 0.10,  3.5, 1.0, 25.0};
  //double paramslower[6] = {alpha_lower, 1.2, 0.01, 1.00, 0.0,  0.0};
  //double paramsupper[6] = {alpha_higher, 3.1, 0.06,  3.50, 1.0, 25.0};

  double paramslower[6] = {alpha_lower, n_lower, 0.01, xA_lower, f_lower,  0.0};
  double paramsupper[6] = {alpha_higher, n_higher, 0.9, xA_higher, f_higher, 25.0};
  ...
  //double sigma_1_init = 0.035; double x_init = 1.9; double f_init = 0.65;
  ...
  //RooRealVar    sigma_1_A("sigma_1_A","width/sigma of the signal gaussian mass PDF",sigma_1_init,sigma_1_init*0.7,sigma_1_init*1.3);
  ...
  //RooRealVar *sl1 = new RooRealVar("sl1","sl1", 0.0, -10., 10.); // 15<pt<50 v2==-1.2 : 0.01
  ...
  if(ptLow == 3.0 && ptHigh == 6.5) pdfMASS_bkg = new RooChebychev("pdfMASS_bkg","Background",*(ws->var("mass")),RooArgList(*sl1,*sl2));
  if(ptLow >= 6.5 ) pdfMASS_bkg = new RooChebychev("pdfMASS_bkg","Background",*(ws->var("mass")),RooArgList(*sl1));
  ...
  if (ptLow==15&&ptHigh==50)  {
	  Double_t NBkg_limit = 1.0e+04;
	  Double_t NJpsi_limit = 1.0e+04; }
  else if (ptLow==7.5&&ptHigh==9)  {
	  Double_t NBkg_limit = 1.0e+04;
	  Double_t NJpsi_limit = 10.0e+03; }
  else if (ptLow==4.5&&ptHigh==6.5)  {
	  Double_t NBkg_limit = 2.0e+05;
	  Double_t NJpsi_limit = 10.0e+04; }
  else if (cLow==100&&cHigh==180){
	  Double_t NBkg_limit = 5.0e+03;
	  Double_t NJpsi_limit = 5.0e+03;  }
  if(ptLow==3 && cLow == 20 && v2 == -2.1) {
	  NBkg_limit = 10.0e+06;
	  NJpsi_limit = 10.0e+05;
  }
  if(ptLow==3.0 && ptHigh==6.5 && cLow == 20 && cHigh == 120 && v2 == -0.3) {
	  NBkg_limit = 1.0e+07;
	  NJpsi_limit = 1.0e+06;
  }
  if(ptLow==3.0 && ptHigh==6.5 && cLow == 20 && cHigh == 120 && v2 == 0.3) {
  ...
  if(ptLow==3.0 && ptHigh==6.5 && cLow == 20 && cHigh == 120 && v2 == -0.9) {
	  NBkg_limit = 9.0e+06;
	  NJpsi_limit = 3.0e+05;
  }

  if(ptLow==3.0 && ptHigh==6.5 && cLow == 20 && cHigh == 120 && v2 == -1.8) {
	  NBkg_limit = 5.0e+06;
	  NJpsi_limit = 1.e+06;
  }

  if(ptLow==3.0 && ptHigh==6.5 && cLow == 20 && cHigh == 120 && v2 == -2.1) {
	  NBkg_limit = 1.0e+07;
	  NJpsi_limit = 1.e+06;
  }

  if(ptLow==3.0 && ptHigh==6.5 && cLow == 20 && cHigh == 120 && v2 == -2.7) {
	  NBkg_limit = 1.0e+07;
	  NJpsi_limit = 1.e+06;
  }
  if(ptLow==3.0 && ptHigh==6.5 && cLow == 20 && cHigh == 120 && v2 == 0.3) {
  ...
  if(ptLow==3.0 && ptHigh==6.5 && cLow == 20 && cHigh == 120 && v2 == 1.2) {
	  NBkg_limit = 1.0e+06;
	  NJpsi_limit = 3.0e+05;
  }

  if(ptLow==3.0 && ptHigh==6.5 && cLow == 20 && cHigh == 120 && v2 == 1.5) {
	  NBkg_limit = 1.0e+06;
	  NJpsi_limit = 3.0e+05;
  }
  ...
  if(ptLow==6.5 && ptHigh == 9.0 && cLow == 20 && cHigh == 120 && v2 == -2.1) {
      NBkg_limit = 4.0e+04;
      NJpsi_limit = 3.0e+04;
  }
  if(ptLow==6.5 && ptHigh == 9.0 && cLow == 20 && cHigh == 120 && v2 == -1.5) {
      NBkg_limit = 1.0e+05;
      NJpsi_limit = 1.0e+05;
  }
  if(ptLow==6.5 && ptHigh == 9.0 && cLow == 20 && cHigh == 120 && v2 == -1.2) {
      NBkg_limit = 1.0e+06;
      NJpsi_limit = 1.0e+05;
  }

  if(ptLow==6.5 && ptHigh == 9.0 && cLow == 20 && cHigh == 120 && v2 == -0.6) {
      NBkg_limit = 7.1e+04;
      NJpsi_limit = 8.0e+04;
  }
  if(ptLow==6.5 && ptHigh == 9.0 && cLow == 20 && cHigh == 120 && v2 == -0.3) {
      NBkg_limit = 1.0e+05;
      NJpsi_limit = 1.0e+05;
  }
  if(ptLow==6.5 && ptHigh == 9.0 && cLow == 20 && cHigh == 120 && v2 == 0) {
      NBkg_limit = 1.0e+05;
      NJpsi_limit = 1.0e+05;
  }
  if(ptLow==6.5 && ptHigh == 9.0 && cLow == 20 && cHigh == 120 && v2 == 0.6) {
  ...
  if(ptLow==9 && ptHigh == 12.0 && cLow == 20 && cHigh == 120 && v2 == -1.8) {
      NBkg_limit = 1.0e+06;
      NJpsi_limit = 1.0e+08;
  }

  if(ptLow==9 && ptHigh == 12.0 && cLow == 20 && cHigh == 120 && v2 == -2.1) {
      NBkg_limit = 10.0e+06;
      NJpsi_limit = 10.0e+08;
  }

  if(ptLow==9 && ptHigh == 12.0 && cLow == 20 && cHigh == 120 && v2 == -2.7) {
      NBkg_limit = 1.0e+06;
      NJpsi_limit = 1.0e+06;
  }
  if(ptLow==9 && ptHigh == 12 && cLow == 20 && cHigh == 120 && v2 == -2.1) {
      NBkg_limit = 10.0e+05;
      NJpsi_limit = 10.0e+06;
  }

  if(ptLow==9 && ptHigh == 12 && cLow == 20 && cHigh == 120 && v2 == 1.8) {
      NBkg_limit = 10.0e+05;
      NJpsi_limit = 10.0e+06;
  }

  if(ptLow==9 && ptHigh == 12.0 && cLow == 20 && cHigh == 120 && v2 == -1.2) {
      NBkg_limit = 10.0e+05;
      NJpsi_limit = 10.0e+06;
  }

  if(ptLow==9 && ptHigh == 12.0 && cLow == 20 && cHigh == 120 && v2 == 0.3) {
      NBkg_limit = 10.0e+05;
      NJpsi_limit = 10.0e+06;
  }

  if(ptLow==9 && ptHigh == 12.0 && cLow == 20 && cHigh == 120 && v2 == 0.6) {
      NBkg_limit = 10.0e+04;
      NJpsi_limit = 10.0e+04;
  }
  ...
  if(ptLow==12 && ptHigh == 15 && cLow == 20 && cHigh == 120 && v2 == -2.7) {
      NBkg_limit = 10.0e+05;
      NJpsi_limit = 10.0e+06;
  }
  if(ptLow==12 && ptHigh == 15 && cLow == 20 && cHigh == 120 && v2 == 1.2) {
      NBkg_limit = 10.0e+06;
      NJpsi_limit = 10.0e+08;
  }
  if(ptLow==12 && cLow == 20 && v2 == 0) {
      NBkg_limit = 2.0e+09;
      NJpsi_limit = 10.0e+08;
  }

  if(ptLow==12 && cLow == 20 && v2 == -2.1) {
      NBkg_limit = 2.0e+09;
      NJpsi_limit = 10.0e+08;
  }
  if(ptLow==12 && ptHigh == 15 && cLow == 20 && cHigh == 120 && v2==1.8) {
      NBkg_limit = 3.0e+03;
      NJpsi_limit = 6.0e+03;
  }
  if(ptLow==12 && ptHigh == 15 && cLow == 20 && cHigh == 120 && v2==-0.6) {
      NBkg_limit = 1.0e+05;
      NJpsi_limit = 6.0e+05;
  }
  if(ptLow==12 && ptHigh == 15 && cLow == 20 && cHigh == 120 && v2==1.2) {
  ...
  if(ptLow==12 && ptHigh == 15 && cLow == 20 && cHigh == 120 && v2==-2.1) {
      NBkg_limit = 1.0e+05;
      NJpsi_limit = 6.0e+05;
  }
  if(ptLow==12 && ptHigh == 15 && cLow == 20 && cHigh == 120 && v2==0) {
      NBkg_limit = 1.0e+05;
      NJpsi_limit = 6.0e+05;
  }
  if(ptLow==12 && ptHigh == 15 && cLow == 20 && cHigh == 120 && v2==0.6) {
  ...
  if(ptLow==12 && ptHigh == 15 && cLow == 20 && cHigh == 120 ) {
      NBkg_limit = 7.0e+06;
      NJpsi_limit = 6.0e+05;
  }
...
//	  NJpsi_limit = 1.0e+04;  }
//
  if(ptLow==15 && ptHigh == 50 && cLow == 20 && cHigh == 120 ) {
      NBkg_limit = 7.0e+06;
      NJpsi_limit = 6.0e+05;
  }
  if(ptLow==15 && ptHigh == 50 && v2 == -0.6) {
      NBkg_limit = 3.0e+08;
      NJpsi_limit = 10.0e+07;
  }

  if(ptLow==15 && ptHigh == 50 && v2 == 0) {
      NBkg_limit = 3.0e+08;
      NJpsi_limit = 10.0e+07;
  }
  if(ptLow==15 && ptHigh == 50 && cLow == 20 && cHigh == 120 && v2==0.) {
      NBkg_limit = 7.0e+05;
      NJpsi_limit = 6.0e+04;
  }
  if(ptLow==15 && ptHigh == 50 && cLow == 20 && cHigh == 120 && v2==-1.2) {
      NBkg_limit = 7.0e+03;
      NJpsi_limit = 6.0e+03;
  }
  if(ptLow==6.5 && ptHigh == 50 && cLow == 80 && cHigh == 180 && v2==-1.2) {
      NBkg_limit = 5.0e+03;
      NJpsi_limit = 3.0e+03;
  }
  if(ptLow==6.5 && cLow == 0 && v2 == -2.7) {
      NBkg_limit = 10.0e+06;
      NJpsi_limit = 10.0e+07;
  }

  if(ptLow==6.5 && cLow == 0 && v2 == -1.8) {
      NBkg_limit = 1.0e+06;
      NJpsi_limit = 1.0e+06;
  }
  if(ptLow==6.5 && cLow == 0 && v2 == -1.5) {
      NBkg_limit = 6.0e+05;
      NJpsi_limit = 4.0e+05;
  }
  if(ptLow==6.5 && cLow == 0 && v2 == -1.2) {
      NBkg_limit = 1.0e+06;
      NJpsi_limit = 1.0e+06;
  }
  if(ptLow==6.5 && cLow == 0 && v2 == -0.9) {
      NBkg_limit = 10.0e+06;
      NJpsi_limit = 10.0e+07;
  }
  if(ptLow==6.5 && cLow == 0 && v2 == -0.3) {
      NBkg_limit = 1.0e+07;
      NJpsi_limit = 1.0e+06;
  }
  if(ptLow==6.5 && cLow == 0 && v2 == 0.6) {
      NBkg_limit = 9.0e+05;
      NJpsi_limit = 6.0e+05;
  }
  if(ptLow==6.5 && cLow == 0 && v2 == 0.9) {
  ...
  if(ptLow==6.5 && cLow == 40 && v2 == -1.2) {
      NBkg_limit = 2.0e+07;
      NJpsi_limit = 10.0e+06;
  }

  if(ptLow==6.5 && cLow == 40 && v2 == -2.7) {
      NBkg_limit = 1.0e+05;
      NJpsi_limit = 1.0e+05;
  }
  if(ptLow==6.5 && cLow == 40 && v2 == -0.3) {
      NBkg_limit = 1.0e+06;
      NJpsi_limit = 1.0e+06;
  }
  ...
  if(ptLow==6.5 && cLow == 40 && v2 == 2.1) {
      NBkg_limit = 2.0e+05;
      NJpsi_limit = 1.0e+05;
  }
  if(ptLow==6.5 && ptHigh == 50 && cLow == 80 && cHigh == 180 && v2==0.6) {
      NBkg_limit = 1.0e+04;
      NJpsi_limit = 6.0e+04;
  }

  if(ptLow==6.5 && ptHigh == 50 && cLow == 80 && cHigh == 180 && v2==-0.9) {
      NBkg_limit = 1.0e+04;
      NJpsi_limit = 3.0e+04;
  }
  ...
  if(ptLow==6.5 && ptHigh == 50 && cLow == 80 && cHigh == 180 && v2==-1.5) {
      NBkg_limit = 1.0e+04;
      NJpsi_limit = 6.0e+04;
  }
  if(ptLow==6.5 && ptHigh == 50 && cLow == 80 && cHigh == 180 && v2==-2.7) {
      NBkg_limit = 1.0e+04;
      NJpsi_limit = 6.0e+04;
  }
  //NBkg_limit = 3.0e+08;
  ...
  TLegend* leg_B = new TLegend(text_x+0.45,text_y-0.2,text_x+0.65,text_y); leg_B->SetTextSize(text_size);
  ...
  if(yLow==0)drawText(Form("|y^{#mu#mu}| < %.1f",yHigh), text_x,text_y-y_diff,text_color,text_size);
  //else if(yLow!=0)drawText(Form("%.1f < |y^{#mu#mu}| < %.1f",yLow, yHigh), text_x,text_y-y_diff,text_color,text_size);
  else if(yLow!=0)drawText(Form("%.1f < |y^{#mu#mu}| < %.1f ;  %.1f < v_{3} < %.1f",yLow, yHigh, v2, v2+0.3), text_x,text_y-y_diff,text_color,text_size);
  //drawText(Form("Cent. %d - %d%s", cLow/2, cHigh/2, "%"),text_x,text_y-y_diff*2,text_color,text_size);
  ...
  drawText(Form("m_{J/#psi} = %.4f #pm %.4f",ws->var("m_{J/#Psi}")->getVal(),ws->var("m_{J/#Psi}")->getError()),text_x,text_y-y_diff*4,text_color,text_size);
  drawText(Form("#alpha_{J/#psi} = %.4f #pm %.4f",ws->var("alpha_1_A")->getVal(),ws->var("alpha_1_A")->getError()),text_x,text_y-y_diff*5,text_color,text_size);
  drawText(Form("f_{J/#psi} = %.4f #pm %.4f",ws->var("f")->getVal(),ws->var("f")->getError()),text_x,text_y-y_diff*6,text_color,text_size);
  drawText(Form("n_{J/#psi} = %.4f #pm %.4f",ws->var("n_1_A")->getVal(),ws->var("n_1_A")->getError()),text_x,text_y-y_diff*7,text_color,text_size);
  drawText(Form("#sigma1_{J/#psi} = %.2f #pm %.2f MeV/c^{2}",(ws->var("sigma_1_A")->getVal())*1000,(ws->var("sigma_1_A")->getError())*1000),text_x,text_y-y_diff*8,text_color,text_size);
  drawText(Form("(#sigma2/#sigma1)_{J/#psi} = %.3f #pm %.3f",ws->var("x_A")->getVal(),ws->var("x_A")->getError()),text_x,text_y-y_diff*9,text_color,text_size);
  
  //if(v2==2.1) drawText(Form("%.1f < v_{3} < %.1f",v2,v2+0.6),text_x+0.5,text_y-y_diff*7,text_color,text_size);
  //else if(v2==-2.7) drawText(Form("%.1f < v_{3} < %.1f",v2,v2+0.6),text_x+0.5,text_y-y_diff*7,text_color,text_size);
  //else drawText(Form("%.1f < v_{3} < %.1f",v2,v2+0.3),text_x+0.5,text_y-y_diff*7,text_color,text_size);
  ...
  TFile* outFile;
  outFile = new TFile(Form("roots/2DFit_%s/Mass_v2Bins_n/Mass_FixedFitResult_%s_%sw_Effw%d_Accw%d_PtW%d_TnP%d_v2_%.2f.root", DATE.Data(), kineLabel.Data(), fname.Data(), fEffW, fAccW, isPtW, isTnP, v2),"recreate");
  c_A->SaveAs(Form("figs/2DFit_%s/Mass_v2Bins_n/Mass_Fixed_%s_%sw_Effw%d_Accw%d_PtW%d_TnP%d_v2_%.2f.pdf", DATE.Data(), kineLabel.Data(), fname.Data(), fEffW, fAccW, isPtW, isTnP, v2));
  pdfMASS_Tot->Write();
  pdfMASS_bkg->Write();
  datasetMass->Write();
  ws->Write();
