...
//  f1 = new TFile("/Users/hwan/tools/2019/CMS/JPsi/Jpsi_v2_PbPb2018/skimmedFiles/vnCut/OniaRooDataSet_isMC0_JPsi_pt3.0-4.5_y1.6-2.4_muPt0.0_centrality20-120_m2.6-3.5_OS_Effw0_Accw0_PtW1_TnP1_211110.root");
  ...
  TFile * f_fit = new TFile(Form("../../21_11_11/roots_MC_Root618_v2Final/Mass/MassFitResult_%s_PRw_Effw%d_Accw%d_PtW%d_TnP%d_test.root",kineLabel.Data(),fEffW,fAccW,isPtW,isTnP));
  ...
  if (ptLow==15&&ptHigh==50)  {
	  NBkg_limit = 1.0e+04;
	  NJpsi_limit = 1.0e+04; }
  else if (v2==2.1&&ptLow==3&&ptHigh==6.5)  {
	  NBkg_limit = 6e+04;
	  NJpsi_limit = 1.0e+04; }
	  ...
	  NBkg_limit = 1.0e+04;
	  NJpsi_limit = 1.0e+04; }
  else if (v2==-2.1&&ptLow==20&&ptHigh==25)  {
	  NBkg_limit = 500;
	  NJpsi_limit = 500; }
  else if (ptLow==20&&ptHigh==25)  {
	  NBkg_limit = 5.0e+03;
	  NJpsi_limit = 2.0e+03; }
  else if (v2==-2.7&&cLow==0&&cHigh==20){
	  NBkg_limit = 5.0e+03;
	  NJpsi_limit = 5.0e+03;  }
	  ...
	  NBkg_limit = 5.0e+04;
	  NJpsi_limit = 5.0e+04;  }
  else if (v2==-2.7&&cLow==100&&cHigh==180){
	  NBkg_limit = 1.0e+04;
	  NJpsi_limit = 2.0e+04;  }
