    ...
    )
{
  ...
  f1 = new TFile(Form("/Users/hwan/tools/2019/CMS/JPsi/Jpsi_v2_PbPb2018/skimmedFiles/v2Cut_EffSys1/OniaRooDataSet_isMC0_JPsi_%s_m2.6-3.5_OS_Effw%d_Accw%d_PtW%d_TnP%d_%s_220119.root",kineLabel.Data(),fEffW,fAccW,0,isTnP,DATE.Data()));
...
//  ctauErrMax = 0.06;}//0.124872
  ...
  //if(ptLow==6.5&&ptHigh==7.5&&cLow==20&&cHigh==120) ws->factory("b_Jpsi[0.23, 0., 1.]");//NP fraction for Sig
