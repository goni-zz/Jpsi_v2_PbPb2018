    ...
    )
{
  ...
  gSystem->mkdir(Form("roots/2DFit_%s/CtauErr_v2Bins",DATE.Data()),kTRUE);
  gSystem->mkdir(Form("figs/2DFit_%s/CtauErr_v2Bins",DATE.Data()),kTRUE);
...
//  RooBinning bins(nBins, ctauErrLow, ctauErrHigh);
  ...
  if(cLow==0 && cHigh==40 && v2 == 0.3) ctauErrMax = 0.0882; 
  if(cLow==0 && cHigh==40 && v2 == -0.9) ctauErrMax = 0.1026; 
  if(cLow==0 && cHigh==40 && v2 == -1.2) ctauErrMax = 0.1062; 
  ...
  if(cLow==80 && cHigh==180 && v2 == -0.3) ctauErrMax = 0.0698; 
  ...
  if(cLow==80 && cHigh==180 && v2 == 1.2) ctauErrMin = 0.0108; 
  ...
  if(cLow==20 && cHigh==120 && ptLow == 3.0 && ptHigh == 6.5 && v2 == -0.6) ctauErrMax = 0.1476; 
  if(cLow==20 && cHigh==120 && ptLow == 3.0 && ptHigh == 6.5 && v2 == -1.2) ctauErrMax = 0.135; 
  if(cLow==20 && cHigh==120 && ptLow == 3.0 && ptHigh == 6.5 && v2 == -1.5) ctauErrMax = 0.1438; 
  ...
  if(cLow==20 && cHigh==120 && ptLow == 3.0 && ptHigh == 6.5 && v2 == 1.8) ctauErrMax = 0.126; 
  if(cLow==20 && cHigh==120 && ptLow == 6.5 && ptHigh == 9.0 && v2 == 0) ctauErrMax = 0.124; 
  ...
  if(cLow==20 && cHigh==120 && ptLow == 9.0 && ptHigh == 12.0 && v2 == 0.0) ctauErrMax = 0.0799; 
...
//  if(cLow==20 && cHigh==120 && ptLow == 12.0 && ptHigh == 15.0 && v2 == 0.3) ctauErrMax = 0.0558; 
  if(cLow==20 && cHigh==120 && ptLow == 12.0 && ptHigh == 15.0 && v2 == 0.6) ctauErrMax = 0.05858; 
  ...
  c_B->Update();
  c_B->SaveAs(Form("figs/2DFit_%s/CtauErr_v2Bins/ctauErr_%s_%sw_Effw%d_Accw%d_PtW%d_TnP%d_v2_%.2f.pdf", DATE.Data(), kineLabel.Data(), fname.Data(), fEffW, fAccW, isPtW, isTnP, v2));
