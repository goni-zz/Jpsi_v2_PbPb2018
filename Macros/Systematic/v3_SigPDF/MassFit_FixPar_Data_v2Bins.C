...
void MassFit_FixPar_Data_v2Bins(
    double v2=0,
    ...
    )
{
  ...
  gSystem->mkdir(Form("roots/2DFit_%s/Mass_v2Bins",DATE.Data()),kTRUE);
  gSystem->mkdir(Form("figs/2DFit_%s/Mass_v2Bins",DATE.Data()),kTRUE);
...
//  f1 = new TFile("/Users/hwan/tools/2019/CMS/JPsi/Jpsi_v2_PbPb2018/skimmedFiles/vnCut/OniaRooDataSet_isMC0_JPsi_pt3.0-4.5_y1.6-2.4_muPt0.0_centrality20-120_m2.6-3.5_OS_Effw0_Accw0_PtW1_TnP1_211110.root");
  ...
  TFile * f_fit = new TFile(Form("../../21_11_11/roots_MC_Root618_v2Final/Mass_CBGauss/MassFitResult_%s_PRw_Effw%d_Accw%d_PtW%d_TnP%d_test.root",kineLabel.Data(),fEffW,fAccW,isPtW,isTnP));
  ...
  if(v2==-0.3&&ptLow==3&&ptHigh==6.5) sigma_index=3;
  ...
  else if(v2==-0.3&&cLow==0&&cHigh==40) sigma_index=3;
...
//  if(ptLow==3.0 && ptHigh==6.5 && cLow == 20 && cHigh == 120 ) {
// 	  NBkg_limit = 2.0e+07;
// 	  NJpsi_limit = 1.e+06;
//   }
  ...
  if(ptLow==6.5 && ptHigh == 9.0 && cLow == 20 && cHigh == 120 && v2 == 0.9) {
      NBkg_limit = 1.0e+05;
      NJpsi_limit = 1.0e+05;
  }

  if(ptLow==6.5 && ptHigh == 9.0 && cLow == 20 && cHigh == 120 && v2 == 1.8) {
      NBkg_limit = 1.0e+05;
      NJpsi_limit = 2.0e+05;
  }
  ...
  if(ptLow==9 && ptHigh == 12.0 && cLow == 20 && cHigh == 120 && v2 == -0.9) {
      NBkg_limit = 10.0e+05;
      NJpsi_limit = 10.0e+06;
  }
  if(ptLow==9 && ptHigh == 12.0 && cLow == 20 && cHigh == 120 && v2 == 0.) {
      NBkg_limit = 1.0e+04;
      NJpsi_limit = 1.0e+05;
  }
  ...
  if(ptLow==12 && ptHigh == 15 && cLow == 20 && cHigh == 120 && v2==-0.9) {
      NBkg_limit = 1.0e+05;
      NJpsi_limit = 6.0e+05;
  }
  if(ptLow==12 && ptHigh == 15 && cLow == 20 && cHigh == 120 && v2==1.2) {
  ...
  if(ptLow==12 && ptHigh == 15 && cLow == 20 && cHigh == 120 && v2==0.3) {
      NBkg_limit = 1.0e+05;
      NJpsi_limit = 6.0e+05;
  }
  if(ptLow==12 && ptHigh == 15 && cLow == 20 && cHigh == 120 && v2==0.6) {
...
//
  ...
  if(ptLow==15 && ptHigh == 50 && cLow == 20 && cHigh == 120 && v2==1.5) {
      NBkg_limit = 7.0e+05;
      NJpsi_limit = 6.0e+04;
  }
  if(ptLow==15 && ptHigh == 50 && cLow == 20 && cHigh == 120 && v2==2.1) {
      NBkg_limit = 7.0e+05;
      NJpsi_limit = 6.0e+04;
  }
  ...
  if(ptLow==6.5 && ptHigh == 50 && cLow == 80 && cHigh == 180 && v2==2.1) {
      NBkg_limit = 1.0e+04;
      NJpsi_limit = 6.0e+04;
  }
  //NBkg_limit = 3.0e+08;
...
//  else drawText(Form("%.1f < v_{3} < %.1f",v2,v2+0.3),text_x+0.5,text_y-y_diff*7,text_color,text_size);
  ...
  TFile* outFile;
  outFile = new TFile(Form("roots/2DFit_%s/Mass_v2Bins/Mass_FixedFitResult_%s_%sw_Effw%d_Accw%d_PtW%d_TnP%d_v2_%.2f.root", DATE.Data(), kineLabel.Data(), fname.Data(), fEffW, fAccW, isPtW, isTnP, v2),"recreate");
  c_A->SaveAs(Form("figs/2DFit_%s/Mass_v2Bins/Mass_Fixed_%s_%sw_Effw%d_Accw%d_PtW%d_TnP%d_v2_%.2f.pdf", DATE.Data(), kineLabel.Data(), fname.Data(), fEffW, fAccW, isPtW, isTnP, v2));
  pdfMASS_Tot->Write();
  pdfMASS_bkg->Write();
  datasetMass->Write();
  ws->Write();
