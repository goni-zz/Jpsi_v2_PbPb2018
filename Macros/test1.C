    ...
    )
{
  ...
  gSystem->mkdir("../roots/2DFit_20210114/CtauRes");
  gSystem->mkdir("../figs/2DFit_20210114/CtauRes");
  ...
  fMass = new TFile(Form("../roots/2DFit_20210114/Mass/MassFitResult_%s_%s.root",bCont.Data(),kineLabel.Data()));
  fCErr = new TFile(Form("../roots/2DFit_20210114/CtauErr/CtauErrResult_%s_%s.root",bCont.Data(),kineLabel.Data()));
  ...
  RooDataSet *ctauResCutDS =(RooDataSet*)dataw_Sig->reduce(RooArgSet(*(ws->var("ctau3DRes")),*(ws->var("ctau3D")),*(ws->var("ctau3DErr"))),"ctau3DRes<0&&ctau3DErr>0.02");
  ...
  ws->factory("ctau1_CtauRes[0.]");  ws->factory("s1_CtauRes[0.1, 1e-6, 10.]");
  ws->factory("ctau2_CtauRes[0.]");  ws->factory("s2_CtauRes[0.1, 1e-6, 10.]");
  ws->factory("ctau3_CtauRes[0.]");  ws->factory("s3_CtauRes[1.1, 1e-6, 10.]");
  ...
  c_C->Update();
  c_C->SaveAs(Form("../figs/2DFit_20210114/CtauRes/CtauRes_%s_%s.pdf",bCont.Data(),kineLabel.Data()));

  TFile *outFile = new TFile(Form("../roots/2DFit_20210114/CtauRes/CtauResResult_%s_%s.root",bCont.Data(),kineLabel.Data()),"recreate");
  ctauResModel->Write();
