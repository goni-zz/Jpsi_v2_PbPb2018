    ...
    )
{
  ...
  gSystem->mkdir(Form("../../roots/2DFit_%s/",DATE.Data()), kTRUE);
  ...
  fCTrue = new TFile(Form("../roots/2DFit_20210325/CtauTrue/CtauTrueResult_%s_%s.root",bCont.Data(),kineLabel.Data()));
...
//  RooDataSet* dsToFit = (RooDataSet*)dsTot->reduce(Form("ctau3DErr>=0.0126009&&ctau3DErr<=0.09"))->Clone("dsTot");
  ...
  else if(ptLow==6.5&&ptHigh==7.5){ws->factory("b_Jpsi[0.25, 0.12, 0.26]");}//NP fraction for Sig
