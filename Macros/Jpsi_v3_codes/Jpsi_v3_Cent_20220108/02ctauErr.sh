...
do
  ...
  root -l -b -q 'CtauErr_v2Bin.C('$v2',6.5,50.0,0.0,2.4,0,40)'
  root -l -b -q 'CtauErr_v2Bin.C('$v2',6.5,50.0,0.0,2.4,40,80)'
  root -l -b -q 'CtauErr_v2Bin.C('$v2',6.5,50.0,0.0,2.4,80,180)'
done
