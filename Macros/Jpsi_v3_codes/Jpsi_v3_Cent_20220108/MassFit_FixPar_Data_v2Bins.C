...
//  f1 = new TFile("/Users/hwan/tools/2019/CMS/JPsi/Jpsi_v2_PbPb2018/skimmedFiles/vnCut/OniaRooDataSet_isMC0_JPsi_pt3.0-4.5_y1.6-2.4_muPt0.0_centrality20-120_m2.6-3.5_OS_Effw0_Accw0_PtW1_TnP1_211110.root");
  ...
  if(ptLow==6.5 && ptHigh==50 && cLow == 0 && cHigh == 40 && v2 == -1.8) {
      NBkg_limit = 10.0e+07;
      NJpsi_limit = 10.0e+08;
  }

  if(ptLow==6.5 && ptHigh==50 && cLow == 40 && cHigh == 80 && v2 == 1.2) {
      NBkg_limit = 10.0e+07;
      NJpsi_limit = 10.0e+08;
  }

  if(ptLow==6.5 && ptHigh==50 && cLow == 40 && cHigh == 80 && v2 == 1.5) {
      NBkg_limit = 10.0e+07;
      NJpsi_limit = 10.0e+08;
  }

  if(ptLow==6.5 && ptHigh==50 && cLow == 40 && cHigh == 80 && v2 == -2.7) {
      NBkg_limit = 10.0e+07;
      NJpsi_limit = 10.0e+08;
  }
  //NBkg_limit = 10.0e+12;
  //NJpsi_limit = 10.0e+09;
