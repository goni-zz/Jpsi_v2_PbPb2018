...
void drawV3Sig_nPart_D0method(){
  ...
  float centBin[nCentBins+1]={309.6, 159.6, 39.134};
  //const int nCentBins=6;
  //float centBin[nCentBins+1]={356.9,262.3,188.2,131.0,87.19,27.12};
  ...
  // v3 
  TFile *fCent1 = new TFile("v2_D0method_pt6.5-50.0_y0.0-2.4_muPt0.0_centrality0-40.root","read");
  TFile *fCent2 = new TFile("v2_D0method_pt6.5-50.0_y0.0-2.4_muPt0.0_centrality40-80.root","read");
  TFile *fCent3 = new TFile("v2_D0method_pt6.5-50.0_y0.0-2.4_muPt0.0_centrality80-180.root","read");
  ...
  gPR->SetPoint(0,centBin[0],yPRcent1);
  gPR->SetPointError(0,0,yPRcent1Err);
  gPR->SetPoint(1,centBin[1],yPRcent2);
  gPR->SetPointError(1,0,yPRcent2Err);
  gPR->SetPoint(2,centBin[2],yPRcent3);
  gPR->SetPointError(2,0,yPRcent3Err);
  //gPR->SetPoint(3,centBin[3],yPRcent4);
  //gPR->SetPointError(3,0,yPRcent4Err);
  //gPR->SetPoint(4,centBin[4],yPRcent5);
  //gPR->SetPointError(4,0,yPRcent5Err);
  //gPR->SetPoint(5,centBin[5],yPRcent6);
  ...
  c1->Update();
  c1->SaveAs(Form("new_v3_npart.pdf"));
  c1->SaveAs(Form("new_v3_npart.png"));
  ...
  TFile *out = new TFile(Form("out_new_v3_vs_npart.root"),"recreate");
//  out->cd();
