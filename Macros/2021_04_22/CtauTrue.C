    ...
    )
{
  ...
  ws->var("ctau3Dtrue")->setRange(0.01, ctau3DTrueMax);
  ws->var("ctau3Dtrue")->setRange("ctauTrueRange", 0.01, ctau3DTrueMax);
  ...
  ws->factory("lambdaDSS[0.5, -5., 5.0]");
  ws->factory("lambdaDSS2[1.3, -5., 5.0]");
  ws->factory("lambdaDSS3[0.9, -5., 5.0]");
