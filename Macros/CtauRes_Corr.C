    ...
    )
{
  ...
  if(ptLow==6.5&&ptHigh==7&&cLow==20&&cHigh==120){
    ...
    ws->factory("rS32_CtauRes[3.5, 1.0, 10.0]");}
  ...
  else {ws->factory("f_CtauRes[0.5, 1e-3, 1.]");ws->factory("f2_CtauRes[0.4, 1e-3, 1.]");ws->factory("f3_CtauRes[0.5, 0., 1.]");}
  ...
  //if(ptLow==7.5&&cLow==40) ctauResMin=-5.8;
  if(ptLow==12&&ptHigh==20) ctauResMin=-10.0;
  else if(ptLow==4&&ptHigh==5) ctauResMin=-9.0;
  //ctauResMin=-8.0;
