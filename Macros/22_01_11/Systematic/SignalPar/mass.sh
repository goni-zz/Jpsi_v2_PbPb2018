...
for v2 in '0' '0.3' '0.6' '0.9' '1.2' '1.5' '1.8' '2.1' '2.4' '-0.3' '-0.6' '-0.9' '-1.2' '-1.5' '-1.8' '-2.1' '-2.4' '-2.7'
  ...
  do
    root -l -b -q 'MassFit_FixPar_Data_v2Bins.C('$v2',6.5,50,0,2.4,'$cent')'
  done
done
...
for v2 in '0' '0.3' '0.6' '0.9' '1.2' '1.5' '1.8' '2.1' '2.4' '-0.3' '-0.6' '-0.9' '-1.2' '-1.5' '-1.8' '-2.1' '-2.4' '-2.7'
  ...
  do
    root -l -b -q 'MassFit_FixPar_Data_v2Bins.C('$v2','$pt',1.6,2.4,20,120)'
  done
done
...
for v2 in '0' '0.3' '0.6' '0.9' '1.2' '1.5' '1.8' '2.1' '2.4' '-0.3' '-0.6' '-0.9' '-1.2' '-1.5' '-1.8' '-2.1' '-2.4' '-2.7'
  ...
  do
    root -l -b -q 'MassFit_FixPar_Data_v2Bins.C('$v2','$pt',0,2.4,20,120)'
  done
done
