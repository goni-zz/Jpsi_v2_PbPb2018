    ...
    )
{
  ...
  f1 = new TFile(Form("../../../../skimmedFiles/v2Cut_Eff1/OniaRooDataSet_isMC0_JPsi_%s_m2.6-3.5_OS_Effw%d_Accw%d_PtW%d_TnP%d_%s_220113.root",kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,DATE.Data()));
  ...
  TFile * f_fit = new TFile(Form("../../Mass_CBGauss/MassFitResult_%s_PRw_Effw%d_Accw%d_PtW%d_TnP%d_test.root",kineLabel.Data(),fEffW,fAccW,isPtW,isTnP));
