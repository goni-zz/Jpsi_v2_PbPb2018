...
//  else if(v2==-2.7&&cLow==20&&cHigh==40) ctauErrMax=0.0468;
  ...
  else if(v2==0.3&&cLow==80&&cHigh==100) ctauErrMax=0.1025;
...
*/
  ...
  drawText(Form("Loss: (%.4f%s) %.f evts", (outTot-outRes)*100/outTot, "%", outTot-outRes),text_x,text_y-y_diff*2,text_color,text_size);
