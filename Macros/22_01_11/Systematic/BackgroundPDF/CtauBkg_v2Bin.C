...
/*
  ...
  else if (v2==1.8&&cLow==40&&cHigh==60) {ctauMin=-0.6; }
...
//  RooDataSet* dataToFit = (RooDataSet*)dataw_Bkg->reduce(Form("ctau3D>=%.f&&ctau3D<=%.f",-2.0, 4.0))->Clone("dataw_Bkg");
  ...
  if(v2==2.1||v2==-2.7)drawText(Form("v2: %.2f - %.2f", v2, v2+0.6), text_x,text_y-y_diff*3,text_color,text_size);
  else drawText(Form("v2: %.2f - %.2f", v2, v2+0.3), text_x,text_y-y_diff*3,text_color,text_size);
