...
void v2mass_hist_weight_HFDown(
    ...
    ) //PR 0: PR, 1: NP, 2: Inc.
{
  ...
  gSystem->mkdir(Form("figs/v2mass_hist_HFDown/%s",DATE.Data()), kTRUE);
  gSystem->mkdir(Form("figs/q_vector_HFDown/%s",DATE.Data()), kTRUE);
  gSystem->mkdir(Form("figs/mass_dist_HFDown/%s",DATE.Data()), kTRUE);
  gSystem->mkdir(Form("figs/decayL_HFDown/%s",DATE.Data()), kTRUE);
  gSystem->mkdir(Form("roots/v2mass_hist_HFDown/%s",DATE.Data()), kTRUE);
  gSystem->mkdir(Form("figs/pt_HFDown/%s",DATE.Data()), kTRUE);
  ...
  if(!isMC){
    TString f1 = "skimmedFiles/OniaFlowSkim_JpsiTrig_AllDBPD_isMC0_HFDown_210729.root";
  ...
  //TFile *fEff = new TFile(Form("./Eff_Acc/mc_eff_vs_pt_cent_20_to_120_rap_%s_pbpb_Jpsi_PtW%d_tnp%d_drawsame2_210525.root",wName.Data(),isPtW,isTnP),"read");
  //TFile *fEff = new TFile(Form("./Eff_Acc/mc_eff_vs_pt_cent_20_to_120_rap_%s_pbpb_Jpsi_PtW%d_tnp%d_drawsame2_0519.root",wName.Data(),isPtW,isTnP),"read");
  //TH1D* hEffPt[8];
  //hEffPt[0] = (TH1D*) fEff -> Get(Form("mc_eff_vs_pt_TnP%d_PtW%d_cent_0_to_200_absy0_2p4",isTnP,isPtW));
  //hEffPt[1] = (TH1D*) fEff -> Get(Form("mc_eff_vs_pt_TnP%d_PtW%d_cent_0_to_200_absy0_0p6",isTnP,isPtW));
  //hEffPt[2] = (TH1D*) fEff -> Get(Form("mc_eff_vs_pt_TnP%d_PtW%d_cent_0_to_200_absy0p6_1p2",isTnP,isPtW));
  //hEffPt[3] = (TH1D*) fEff -> Get(Form("mc_eff_vs_pt_TnP%d_PtW%d_cent_0_to_200_absy1p2_2p6",isTnP,isPtW));
  //hEffPt[4] = (TH1D*) fEff -> Get(Form("mc_eff_vs_pt_TnP%d_PtW%d_cent_0_to_200_absy1p6_1p8",isTnP,isPtW));
  //hEffPt[5] = (TH1D*) fEff -> Get(Form("mc_eff_vs_pt_TnP%d_PtW%d_cent_0_to_200_absy1p8_2p4",isTnP,isPtW));
  //TFile *fEff = new TFile(Form("./Eff_Acc/mc_eff_vs_pt_cent_20_to_120_rap_%s_pbpb_Jpsi_PtW%d_tnp%d_drawsame2_210526.root",wName.Data(),isPtW,isTnP),"read");
  ...
  //hEffPt[4] = (TH1D*) fEff -> Get(Form("mc_eff_vs_pt_TnP%d_PtW%d_cent_40_to_80_absy1p6_1p8",isTnP,isPtW));
  //hEffPt[5] = (TH1D*) fEff -> Get(Form("mc_eff_vs_pt_TnP%d_PtW%d_cent_40_to_80_absy1p8_2p4",isTnP,isPtW));
  //hEffPt[6] = (TH1D*) fEff -> Get(Form("mc_eff_vs_pt_TnP%d_PtW%d_cent_60_to_100_absy1p6_1p8",isTnP,isPtW));
  //hEffPt[7] = (TH1D*) fEff -> Get(Form("mc_eff_vs_pt_TnP%d_PtW%d_cent_60_to_100_absy1p8_2p4",isTnP,isPtW));
  ...
  //TFile *fEff = new TFile(Form("./Eff_Acc/mc_eff_vs_pt_cent_20_to_120_rap_%s_pbpb_Jpsi_PtW%d_tnp%d_210617.root",wName.Data(),isPtW,isTnP),"read");
  TFile *fEff = new TFile(Form("./Eff_Acc/roots/mc_eff_vs_pt_cent_20_to_120_rap_%s_pbpb_Jpsi_PtW%d_tnp%d_20210618.root",wName.Data(),isPtW,isTnP),"read");
  
  TH1D* hEffPt[4];
  hEffPt[0] = (TH1D*) fEff -> Get(Form("mc_eff_vs_pt_TnP%d_PtW%d_cent_20_to_120_absy0p6_1p2",isTnP,isPtW));
  hEffPt[1] = (TH1D*) fEff -> Get(Form("mc_eff_vs_pt_TnP%d_PtW%d_cent_20_to_120_absy1p2_1p6",isTnP,isPtW));
  hEffPt[2] = (TH1D*) fEff -> Get(Form("mc_eff_vs_pt_TnP%d_PtW%d_cent_20_to_120_absy1p6_1p8",isTnP,isPtW));
  hEffPt[3] = (TH1D*) fEff -> Get(Form("mc_eff_vs_pt_TnP%d_PtW%d_cent_20_to_120_absy1p8_2p4",isTnP,isPtW));
  ...
  TFile *fAcc = new TFile(Form("./Eff_Acc/Acc_WeightVariation_PtWF%d_20210426.root",1),"read");
  TH1D* hAccPt[3];
  ...
  //hAccPt[0] = (TH1D*) fAcc -> Get("hAccPt_2021_ally_nowt");
  //hAccPt[1] = (TH1D*) fAcc -> Get("hAccPt_2021_midy_nowt");
  //hAccPt[2] = (TH1D*) fAcc -> Get("hAccPt_2021_Fory_nowt");
  ...
  //if(ctauCut!=2){
  fCErr = new TFile(Form("Macros/2021_04_22/roots/2DFit_%s/CtauErr/CtauErrResult_%s_%sw_Effw%d_Accw%d_PtW%d_TnP%d.root", DATE.Data(), kineLabel.Data(), "PR", 1, 1, 1, 1));
  if(ptLow==3&&ptHigh==6.5)fFinal = new TFile(Form("Macros/2021_04_22/roots/2DFit_%s/Final/nominal/2DFitResult_%s_%sw_Effw%d_Accw%d_PtW%d_TnP%d.root", DATE.Data(), kineLabel.Data(), "PR", 1, 1, 1, 1));
  else fFinal = new TFile(Form("Macros/2021_04_22/roots/2DFit_%s/Final/nominal/2DFitResult_%s_%sw_Effw%d_Accw%d_PtW%d_TnP%d.root", DATE.Data(), kineLabel.Data(), "PR", 1, 1, 1, 1));
    ...
    if(cBin>cLow&&cBin<cHigh){ 
      if(fabs(vz)<15){
        ...
        for(int j=0; j<nDimu; j++){
          ...
          //if(pt[j]>3.&&pt[j]<ptHigh&&recoQQsign[j]==0&&mass[j]>massLow&&mass[j]<massHigh&&abs(y[j])>yLow&&abs(y[j])<yHigh&&
            ...
            if(fEffW){
              ...
              //else if ( abs((double)y[j])>=1.8 && abs((double)y[j])<2.4&&cLow==20&&cHigh==120){weight_eff = getEffWeight(hEffPt[3], pt[j]);}
              //else if ( abs((double)y[j])>=1.6 && abs((double)y[j])<2.4&&cLow==40&&cHigh==80) {weight_eff = getEffWeight(hEffPt[5], pt[j]);}
              ...
              //else if(cLow==20&&cHigh==120&&abs((double)y[j])>=1.6&&abs((double)y[j])<1.8){weight_eff = getEffWeight(hEffPt[2], pt[j]);}
              //else if(cLow==20&&cHigh==120&&abs((double)y[j])>=1.8&&abs((double)y[j])<2.4){weight_eff = getEffWeight(hEffPt[3], pt[j]);}
              //else if(cLow==80&&cHigh==80&&abs((double)y[j])>=1.6&&abs((double)y[j])<1.8){weight_eff = getEffWeight(hEffPt[4], pt[j]);}
              //else if(cLow==40&&cHigh==80&&abs((double)y[j])>=1.8&&abs((double)y[j])<2.4){weight_eff = getEffWeight(hEffPt[5], pt[j]);}
              //else if(cLow==60&&cHigh==100&&abs((double)y[j])>=1.6&&abs((double)y[j])<1.8){weight_eff = getEffWeight(hEffPt[6], pt[j]);}
              //else if(cLow==60&&cHigh==100&&abs((double)y[j])>=1.8&&abs((double)y[j])<2.4){weight_eff = getEffWeight(hEffPt[7], pt[j]);}
              if ( abs((double)y[j])>=0.0 && abs((double)y[j])<1.2 ) { weight_eff = getEffWeight(hEffPt[0], pt[j]); }
              else if ( abs((double)y[j])>=1.2 && abs((double)y[j])<1.6 ) { weight_eff = getEffWeight(hEffPt[1], pt[j]); }
              else if ( abs((double)y[j])>=1.6 && abs((double)y[j])<1.8 ) { weight_eff = getEffWeight(hEffPt[2], pt[j]); }
              else if ( abs((double)y[j])>=1.8 && abs((double)y[j])<2.4 ) { weight_eff = getEffWeight(hEffPt[3], pt[j]); }
  ...
  if(ctauCut==-1){
    ...
    drawText("#font[12]{l}_{J/#psi} Inclusive",pos_x_mass,pos_y-pos_y_diff*4,text_color,text_size);}
    //drawText(Form("NP J/#psi Frac. %.3f", bfrac2),pos_x_mass,pos_y-pos_y_diff*5,text_color,text_size);}
  pad2->SetTopMargin(0);
  ...
  if(ctauCut==0) c_mass_v2->SaveAs(Form("figs/v2mass_hist_HFDown/%s/v2Mass_%s_ctau_%.5f_%.5f_%s_HFDown.pdf",DATE.Data(),kineLabel.Data(),ctauLo,ctauHi,cutName.Data()));
  else if(ctauCut==-1)c_mass_v2->SaveAs(Form("figs/v2mass_hist_HFDown/%s/v2Mass_%s_ctau_%.5f_%s_HFDown.pdf",DATE.Data(),kineLabel.Data(),ctauLo,cutName.Data()));
  else if(ctauCut== 1)c_mass_v2->SaveAs(Form("figs/v2mass_hist_HFDown/%s/v2Mass_%s_ctau_%.5f_%s_HFDown.pdf",DATE.Data(),kineLabel.Data(),ctauHi,cutName.Data()));
  else c_mass_v2->SaveAs(Form("figs/v2mass_hist_HFDown/%s/v2Mass_%s_Inc_HFDown.pdf",DATE.Data(),kineLabel.Data()));
  ...
  //lcut->Draw("same");
  c_pt->Update();
  if(ctauCut==0) c_pt->SaveAs(Form("figs/pt_HFDown/%s/pt_%s_ctau_%.5f_%.5f_%s_HFDown.pdf",DATE.Data(),kineLabel.Data(),ctauLo,ctauHi,cutName.Data()));
  else if(ctauCut==-1)c_pt->SaveAs(Form("figs/pt_HFDown/%s/pt_%s_ctau_%.5f_%s_HFDown.pdf",DATE.Data(),kineLabel.Data(),ctauLo,cutName.Data()));
  else if(ctauCut== 1)c_pt->SaveAs(Form("figs/pt_HFDown/%s/pt_%s_ctau_%.5f_%s_HFDown.pdf",DATE.Data(),kineLabel.Data(),ctauHi,cutName.Data()));
  else c_pt->SaveAs(Form("figs/pt_HFDown/%s/pt_%s_Inc_HFDown.pdf",DATE.Data(),kineLabel.Data()));
  ...
  //lcut->Draw("same");
  c_decayL->Update();
  if(ctauCut==0) c_decayL->SaveAs(Form("figs/decayL_HFDown/%s/decayL_%s_ctau_%.5f_%.5f_%s_HFDown.pdf",DATE.Data(),kineLabel.Data(),ctauLo,ctauHi,cutName.Data()));
  else if(ctauCut==-1)c_decayL->SaveAs(Form("figs/decayL_HFDown/%s/decayL_%s_ctau_%.5f_%s_HFDown.pdf",DATE.Data(),kineLabel.Data(),ctauLo,cutName.Data()));
  else if(ctauCut== 1)c_decayL->SaveAs(Form("figs/decayL_HFDown/%s/decayL_%s_ctau_%.5f_%s_HFDown.pdf",DATE.Data(),kineLabel.Data(),ctauHi,cutName.Data()));
  else c_decayL->SaveAs(Form("figs/decayL_HFDown/%s/decayL_%s_Inc_HFDown.pdf",DATE.Data(),kineLabel.Data()));
  ...
  c_mass->Update();
  if(ctauCut==0)c_mass->SaveAs(Form("figs/mass_dist_HFDown/%s/MassDist_%s_ctau_%.5f_%.5f_%s_HFDown.pdf",DATE.Data(),kineLabel.Data(),ctauLo,ctauHi,cutName.Data()));
  else if(ctauCut==-1)c_mass->SaveAs(Form("figs/mass_dist_HFDown/%s/MassDist_%s_ctau_%.5f_%s_HFDown.pdf",DATE.Data(),kineLabel.Data(),ctauLo,cutName.Data()));
  else if(ctauCut==1)c_mass->SaveAs(Form("figs/mass_dist_HFDown/%s/MassDist_%s_ctau_%.5f_%s_HFDown.pdf",DATE.Data(),kineLabel.Data(),ctauHi,cutName.Data()));
  else c_mass->SaveAs(Form("figs/mass_dist_HFDown/%s/MassDist_%s_Inc_HFDown.pdf",DATE.Data(),kineLabel.Data()));
  ...
  if(ctauCut==0) c_qq_1->SaveAs(Form("figs/q_vector_HFDown/%s/c_qqa_%s_Eff%d_Acc%d_PtW%d_TnP%d_ctau_%.5f_%.5f_%s_HFDown.pdf",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,ctauLo,ctauHi,cutName.Data()));
  else if(ctauCut==-1)c_qq_1->SaveAs(Form("figs/q_vector_HFDown/%s/c_qqa_%s_Eff%d_Acc%d_PtW%d_TnP%d_ctau_%.5f_%s_HFDown.pdf",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,ctauLo,cutName.Data()));
  else if(ctauCut==1)c_qq_1->SaveAs(Form("figs/q_vector_HFDown/%s/c_qqa_%s_Eff%d_Acc%d_PtW%d_TnP%d_ctau_%.5f_%s_HFDown.pdf",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,ctauHi,cutName.Data()));
  else c_qq_1->SaveAs(Form("figs/q_vector_HFDown/%s/c_qqa_%s_Eff%d_Acc%d_PtW%d_TnP%d_Inc_HFDown.pdf",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP));
  ...
  leg_v2_2->Draw("same");
  if(ctauCut==0) c_qq_2->SaveAs(Form("figs/q_vector_HFDown/%s/c_qaqb_%s_Eff%d_Acc%d_PtW%d_TnP%d_ctau_%.5f_%.5f_%s_HFDown.pdf",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,ctauLo,ctauHi,cutName.Data()));
  else if(ctauCut==-1)c_qq_2->SaveAs(Form("figs/q_vector_HFDown/%s/c_qaqb_%s_Eff%d_Acc%d_PtW%d_TnP%d_ctau_%.5f_%s_HFDown.pdf",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,ctauLo,cutName.Data()));
  else if(ctauCut==1)c_qq_2->SaveAs(Form("figs/q_vector_HFDown/%s/c_qaqb_%s_Eff%d_Acc%d_PtW%d_TnP%d_ctau_%.5f_%s_HFDown.pdf",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,ctauHi,cutName.Data()));
  else c_qq_2->SaveAs(Form("figs/q_vector_HFDown/%s/c_qaqb_%s_Eff%d_Acc%d_PtW%d_TnP%d_Inc_HFDown.pdf",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP));
  ...
  leg_v2_3->Draw("same");
  if(ctauCut==0) c_qq_3->SaveAs(Form("figs/q_vector_HFDown/%s/c_qaqc_%s_Eff%d_Acc%d_PtW%d_TnP%d_ctau_%.5f_%.5f_%s_HFDown.pdf",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,ctauLo,ctauHi,cutName.Data()));
  else if(ctauCut==-1)c_qq_3->SaveAs(Form("figs/q_vector_HFDown/%s/c_qaqc_%s_Eff%d_Acc%d_PtW%d_TnP%d_ctau_%.5f_%s_HFDown.pdf",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,ctauLo,cutName.Data()));
  else if(ctauCut== 1)c_qq_3->SaveAs(Form("figs/q_vector_HFDown/%s/c_qaqc_%s_Eff%d_Acc%d_PtW%d_TnP%d_ctau_%.5f_%s_HFDown.pdf",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,ctauHi,cutName.Data()));
  else c_qq_3->SaveAs(Form("figs/q_vector_HFDown/%s/c_qaqc_%s_Eff%d_Acc%d_PtW%d_TnP%d_Inc_HFDown.pdf",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP));
  ...
  leg_v2_4->Draw("same");
  if(ctauCut==0) c_qq_4->SaveAs(Form("figs/q_vector_HFDown/%s/c_qbqc_%s_Eff%d_Acc%d_PtW%d_TnP%d_ctau_%.5f_%.5f_%s_HFDown.pdf",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,ctauLo,ctauHi,cutName.Data()));
  else if(ctauCut==-1)c_qq_4->SaveAs(Form("figs/q_vector_HFDown/%s/c_qbqc_%s_Eff%d_Acc%d_PtW%d_TnP%d_ctau_%.5f_%s_HFDown.pdf",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,ctauLo,cutName.Data()));
  else if(ctauCut==1)c_qq_4->SaveAs(Form("figs/q_vector_HFDown/%s/c_qbqc_%s_Eff%d_Acc%d_PtW%d_TnP%d_ctau_%.5f_%s_HFDown.pdf",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,ctauHi,cutName.Data()));
  else c_qq_4->SaveAs(Form("figs/q_vector_HFDown/%s/c_qbqc_%s_Eff%d_Acc%d_PtW%d_TnP%d_Inc_HFDown.pdf",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP));

  TFile *wf; 
  if(ctauCut==0) wf = new TFile(Form("roots/v2mass_hist_HFDown/%s/Jpsi_%s_Eff%d_Acc%d_PtW%d_TnP%d_ctau_%.5f_%.5f_%s_HFDown.root",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,ctauLo,ctauHi,cutName.Data()),"recreate");
  else if(ctauCut==-1) wf = new TFile(Form("roots/v2mass_hist_HFDown/%s/Jpsi_%s_Eff%d_Acc%d_PtW%d_TnP%d_ctau_%.5f_%s_HFDown.root",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,ctauLo,cutName.Data()),"recreate");
  else if(ctauCut==1) wf = new TFile(Form("roots/v2mass_hist_HFDown/%s/Jpsi_%s_Eff%d_Acc%d_PtW%d_TnP%d_ctau_%.5f_%s_HFDown.root",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,ctauHi,cutName.Data()),"recreate");
  else wf = new TFile(Form("roots/v2mass_hist_HFDown/%s/Jpsi_%s_Eff%d_Acc%d_PtW%d_TnP%d_Inc_HFDown.root",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP),"recreate");
  wf->cd();
  h_v2_final->Write();
  h_decayL->Write();
  g_mass->Write();
