...
void get_Eff_pt_jpsi_pbpb_fit( 
  ...
  const int numBins2 = 4; //50;//(max-min)/binwidth;  //31//
  ...
  if(state==2) outFileName = "mc_eff_vs_pt_cent_nprompt_pbpb_Jpsi_fit_tnp_2.root"; 
  ...
  double ptBin2[numBins2+1] = {0,6.5,8,12,50};
  ...
  TH1D* hpt_gen_1 = new TH1D("hpt_gen_1","hpt_gen_1",numBins2,ptBin2);
  TH1D* hpt_gen_2 = new TH1D("hpt_gen_2","hpt_gen_2",numBins2,ptBin2);
  ...
  TH1D* hpt_reco_Trig_1 = new TH1D("hpt_reco_Trig_1","hpt_reco_Trig_1",numBins2,ptBin2);
  TH1D* hpt_reco_Trig_2 = new TH1D("hpt_reco_Trig_2","hpt_reco_Trig_2",numBins2,ptBin2);
  ...
  //for(int iev=0; iev<300000 ; ++iev)
  {
    ...
    for(int igen = 0; igen<Gen_QQ_size; igen++){
	    ...
	    if(( fabs(JP_Gen->Rapidity())<2.4 && JP_Gen->Pt()<50 && JP_Gen->Pt()>6.5 )) {
		    hpt_gen_1->Fill(JP_Gen->Pt(),weight*pt_weight);}

	    if(( fabs(JP_Gen->Rapidity())<1.6 && JP_Gen->Pt()<50 && JP_Gen->Pt()>6.5 )) {
		    hpt_gen_2->Fill(JP_Gen->Pt(),weight*pt_weight);}

	    if(( fabs(JP_Gen->Rapidity())>1.6 && fabs(JP_Gen->Rapidity())<2.4 && JP_Gen->Pt()<50 && JP_Gen->Pt()>3 )) {
		    hpt_gen_3->Fill(JP_Gen->Pt(),weight*pt_weight);}
...
//         cout << "TnP ERROR !!!! ::: No matched L2 filter1 " << endl;
      ...
      if(HLTPass==true && HLTFilterPass==true){
	      ...
	      if( (fabs(JP_Reco->Rapidity())<2.4 && JP_Reco->Pt()<50 && JP_Reco->Pt()>6.5 )){
		      hpt_reco_Trig_1->Fill(JP_Reco->Pt(),weight* tnp_weight* pt_weight);}

	      if( (fabs(JP_Reco->Rapidity())<1.6 && JP_Reco->Pt()<50 && JP_Reco->Pt()>6.5 )){
		      hpt_reco_Trig_2->Fill(JP_Reco->Pt(),weight* tnp_weight* pt_weight);}

	      if((fabs(JP_Reco->Rapidity())<2.4 && fabs(JP_Reco->Rapidity())>1.6 && JP_Reco->Pt()<50 && JP_Reco->Pt()>3 )){
			      hpt_reco_Trig_3->Fill(JP_Reco->Pt(),weight* tnp_weight* pt_weight);}
  ...
  hpt_eff_Trig_6 = (TH1D*)hpt_reco_Trig_1->Clone("hpt_eff_Trig_6");
  hpt_eff_Trig_7 = (TH1D*)hpt_reco_Trig_2->Clone("hpt_eff_Trig_7");
  hpt_eff_Trig_8 = (TH1D*)hpt_reco_Trig_3->Clone("hpt_eff_Trig_8");
  ...
  hpt_eff_Trig_6->Divide(hpt_eff_Trig_6, hpt_gen_1, 1, 1, "B");
  hpt_eff_Trig_7->Divide(hpt_eff_Trig_7, hpt_gen_2, 1, 1, "B");
  hpt_eff_Trig_8->Divide(hpt_eff_Trig_8, hpt_gen_3, 1, 1, "B");
  ...
  hpt_eff_Trig_6->Fit(f1);
  //f1->SetLineColor(kRed+1);
  f1->SetLineColor(kGreen+1);
  f1->SetLineWidth(2);
  hpt_eff_Trig_7->Fit(f1);
  f1->SetLineColor(kRed-1);
  //f1->SetLineColor(kYellow+1);
  //f1->SetLineColor(kBlue+1);
  f1->SetLineWidth(2);
  hpt_eff_Trig_8->Fit(f1);
  //f1->SetLineColor(kGreen+1);
  //f1->SetLineWidth(2);
...
////Trig
  //TCanvas * cpt_eff_Trig_6 = new TCanvas("cpt_eff_Trig_6","cpt_eff_Trig_6",0,0,400,400);
  //cpt_eff_Trig_6->cd();
  //hpt_eff_Trig_6->Draw();

  //TCanvas * cpt_eff_Trig_7 = new TCanvas("cpt_eff_Trig_7","cpt_eff_Trig_7",0,0,400,400);
  //cpt_eff_Trig_7->cd();
  //hpt_eff_Trig_7->Draw();

  //TCanvas * cpt_eff_Trig_8 = new TCanvas("cpt_eff_Trig_8","cpt_eff_Trig_8",0,0,400,400);
  //cpt_eff_Trig_8->cd();
  //hpt_eff_Trig_8->Draw();
...
//draw same
  ...
  cpt_eff->cd();
  hpt_eff_Trig_6->SetTitle("Efficiency");
  //hpt_eff_Trig_6->SetMarkerStyle(24);
  //hpt_eff_Trig_6->SetMarkerColor(1);
  //hpt_eff_Trig_6->SetLineColor(1);
  hpt_eff_Trig_6->SetMarkerStyle(20);
  hpt_eff_Trig_6->SetMarkerColor(6);
  hpt_eff_Trig_6->SetLineColor(6);
  hpt_eff_Trig_6->GetXaxis()->SetTitle("p_{T}[GeV/c]");
  //hpt_eff_Trig_6->GetXaxis()->SetRangeUser(0.,50);
  hpt_eff_Trig_6->GetYaxis()->SetTitle("Efficiency");
  hpt_eff_Trig_6->GetYaxis()->SetRangeUser(0.,1.3);
  hpt_eff_Trig_6->Draw("E");
  legend->AddEntry("hpt_eff_Trig_6","|y|: 0.0-2.4, 0-90%, 6.5<Pt<50","lep");
  ...
  cpt_eff2->cd();
  hpt_eff_Trig_7->SetTitle("Efficiency");
  //hpt_eff_Trig_7->SetMarkerStyle(25);
  //hpt_eff_Trig_7->SetMarkerColor(2);
  //hpt_eff_Trig_7->SetLineColor(2);
  hpt_eff_Trig_7->SetMarkerStyle(21);
  hpt_eff_Trig_7->SetMarkerColor(3);
  hpt_eff_Trig_7->SetLineColor(3);
  hpt_eff_Trig_7->GetXaxis()->SetTitle("p_{T}[GeV/c]");
  //hpt_eff_Trig_7->GetXaxis()->SetRangeUser(0.,50);
  hpt_eff_Trig_7->GetYaxis()->SetTitle("Efficiency");
  hpt_eff_Trig_7->GetYaxis()->SetRangeUser(0.,1.3);
  hpt_eff_Trig_7->Draw("E");
  legend2->AddEntry("hpt_eff_Trig_7","|y|: 0.0-1.6, 0-90%, 6.5<Pt<50","lep");
  ...
  TCanvas * cpt_eff3 = new TCanvas("cpt_eff3","cpt_eff3",0,0,900,800);
  cpt_eff3->cd();
  hpt_eff_Trig_8->SetTitle("Efficiency");
  //hpt_eff_Trig_8->SetMarkerStyle(26);
  //hpt_eff_Trig_8->SetMarkerColor(4);
  //hpt_eff_Trig_8->SetLineColor(4);
  hpt_eff_Trig_8->SetMarkerStyle(22);
  hpt_eff_Trig_8->SetMarkerColor(28);
  hpt_eff_Trig_8->SetLineColor(28);
  hpt_eff_Trig_8->GetXaxis()->SetTitle("p_{T}[GeV/c]");
  //hpt_eff_Trig_8->GetXaxis()->SetRangeUser(0.,50);
  hpt_eff_Trig_8->GetYaxis()->SetTitle("Efficiency");
  hpt_eff_Trig_8->GetYaxis()->SetRangeUser(0.,1.3);
  hpt_eff_Trig_8->Draw("E");
  legend3->AddEntry("hpt_eff_Trig_5","|y|: 1.6-2.4, 0-90%, 3<Pt<50","lep");
  ...
  //eeeeee
  ////hpt_eff_Trig_7->SetMarkerStyle(24);
  ////hpt_eff_Trig_7->SetMarkerColor(2);
  ////hpt_eff_Trig_7->SetLineColor(2);
  ////hpt_eff_Trig_7->GetXaxis()->SetTitle("p_{T}[GeV/c]");
  ////hpt_eff_Trig_7->GetYaxis()->SetTitle("Efficiency");
  ...
  //hpt_eff_Trig_7->SetMarkerColor(2);
  //hpt_eff_Trig_7->SetLineColor(2);
  //hpt_eff_Trig_7->Draw("same");
  //hpt_eff_Trig_8->SetMarkerStyle(30);
  //hpt_eff_Trig_8->SetMarkerColor(kOrange+1);
  //hpt_eff_Trig_8->SetLineColor(kOrange+1);
  //hpt_eff_Trig_8->Draw("same");
  ...
  ////cpt_eff->BuildLegend();
  ////legend->AddEntry("hpt_eff_Trig_6","|y|: 0-2.4, 0-100%","lep");
  ////legend->AddEntry("hpt_eff_Trig_7","|y|: 0-0.6, 0-100%","lep");
  ////legend->AddEntry("hpt_eff_Trig_8","|y|: 0.6-1.2, 0-100%","lep");
  ////legend->AddEntry("hpt_eff_Trig_4","|y|: 1.2-1.8, 0-100%","lep");
  ////legend->AddEntry("hpt_eff_Trig_5","|y|: 1.8-2.4, 0-100%","lep");
  ////legend->SetBorderSize( 0);
  //legend->AddEntry("hpt_eff_Trig_6","0-90%","lep");
  //legend->AddEntry("hpt_eff_Trig_7","0-10%","lep");
  //legend->AddEntry("hpt_eff_Trig_8","10-30%","lep");
  ...
  //hpt_eff_Trig_6->SetName(Form("mc_eff_Trig_vs_pt_TnP%d_1 ",isTnP));
  //hpt_eff_Trig_7->SetName(Form("mc_eff_Trig_vs_pt_TnP%d_2  ",isTnP));
  //hpt_eff_Trig_8->SetName(Form("mc_eff_Trig_vs_pt_TnP%d_3 ",isTnP));
  ...
  hpt_eff_Trig_6->Write();
  hpt_eff_Trig_7->Write();
  hpt_eff_Trig_8->Write();
