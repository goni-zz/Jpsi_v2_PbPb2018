...
void getAcceptance_jpsi_pbpb(
  ...
  TString outFileName = "mc_Acc_vs_pt_cent_prompt_pbpb_Jpsi.root"; 
  if(state==2) outFileName = "mc_Acc_vs_pt_cent_nprompt_pbpb_Jpsi.root"; 
  ...
  for(int iev=0; iev<300000 ; ++iev)
  {
    ...
    for(int igen = 0; igen<Gen_QQ_size; igen++){
	    ...
	    //hy_gen->Fill(Rapidity_g, weight);
	    hy_reco->Fill(Rapidity_g, weight);
	    //hpt_gen_1->Fill(JP_Gen->Pt(),weight*pt_weight);
	    //if(Rapidity_g < 0.6) hpt_gen_2 -> Fill(JP_Gen->Pt(), weight*pt_weight);
	    //else if(Rapidity_g > 0.6 && Rapidity_g < 1.2) hpt_gen_3 -> Fill(JP_Gen->Pt(), weight*pt_weight);
	    //else if(Rapidity_g > 1.2 && Rapidity_g < 1.8) hpt_gen_4 -> Fill(JP_Gen->Pt(), weight*pt_weight);
	    ...
	    hpt_reco_1->Fill(JP_Gen->Pt(),weight*pt_weight);
	    if(Rapidity_g < 0.6) hpt_reco_2 -> Fill(JP_Gen->Pt(), weight*pt_weight);
	    else if(Rapidity_g > 0.6 && Rapidity_g < 1.2) hpt_reco_3 -> Fill(JP_Gen->Pt(), weight*pt_weight);
	    else if(Rapidity_g > 1.2 && Rapidity_g < 1.8) hpt_reco_4 -> Fill(JP_Gen->Pt(), weight*pt_weight);
	    else if(Rapidity_g > 1.8 && Rapidity_g < 2.4) hpt_reco_5 -> Fill(JP_Gen->Pt(), weight*pt_weight);
    }
...
//         cout << "TnP ERROR !!!! ::: No matched L2 filter1 " << endl;
  ...
  hpt_eff_reco_1 = (TH1D*)hpt_reco_1->Clone("hpt_eff_reco_1");
  hpt_eff_reco_2 = (TH1D*)hpt_reco_2->Clone("hpt_eff_reco_2");
  hpt_eff_reco_3 = (TH1D*)hpt_reco_3->Clone("hpt_eff_reco_3");
  hpt_eff_reco_4 = (TH1D*)hpt_reco_4->Clone("hpt_eff_reco_4");
  hpt_eff_reco_5 = (TH1D*)hpt_reco_5->Clone("hpt_eff_reco_5");
  ...
  hpt_eff_Trig_1->Divide(hpt_eff_Trig_1, hpt_reco_NoTrig_1, 1, 1, "B");
  hpt_eff_Trig_2->Divide(hpt_eff_Trig_2, hpt_reco_NoTrig_2, 1, 1, "B");
  hpt_eff_Trig_3->Divide(hpt_eff_Trig_3, hpt_reco_NoTrig_3, 1, 1, "B");
  hpt_eff_Trig_4->Divide(hpt_eff_Trig_4, hpt_reco_NoTrig_4, 1, 1, "B");
  hpt_eff_Trig_5->Divide(hpt_eff_Trig_5, hpt_reco_NoTrig_5, 1, 1, "B");

  hpt_eff_reco_1->Divide(hpt_eff_reco_1, hpt_reco_NoTrig_1, 1, 1, "B");
  hpt_eff_reco_2->Divide(hpt_eff_reco_2, hpt_reco_NoTrig_2, 1, 1, "B");
  hpt_eff_reco_3->Divide(hpt_eff_reco_3, hpt_reco_NoTrig_3, 1, 1, "B");
  hpt_eff_reco_4->Divide(hpt_eff_reco_4, hpt_reco_NoTrig_4, 1, 1, "B");
  hpt_eff_reco_5->Divide(hpt_eff_reco_5, hpt_reco_NoTrig_5, 1, 1, "B");
...
//draw same
  ...
  //hpt_eff_1->SetMarkerSize(7);
  hpt_eff_1->SetMarkerColor(1);
  hpt_eff_1->SetLineColor(1);
  //hpt_eff_1->GetXaxis()->CenterTitle();
  hpt_eff_1->GetXaxis()->SetTitle("p_{T}[GeV/c]");
  //hpt_eff_1->GetYaxis()->CenterTitle();
  hpt_eff_1->GetYaxis()->SetTitle("Acceptance");
  ...
  //hpt_eff_2->GetYaxis()->SetTitle("Acceptance");
  ...
  hpt_eff_2->SetMarkerColor(2);
  hpt_eff_2->SetLineColor(2);
  hpt_eff_2->Draw("same");
  ...
  hpt_eff_4->SetMarkerColor(3);
  hpt_eff_4->SetLineColor(3);
  hpt_eff_4->Draw("same");
  hpt_eff_5->SetMarkerStyle(27);
  hpt_eff_5->SetMarkerColor(4);
  hpt_eff_5->SetLineColor(4);
  hpt_eff_5->Draw("same");
  //cpt_eff->BuildLegend();
  //legend->AddEntry("hpt_eff_1","|y|: 0-2.4, 0-100%","lep");
  //legend->AddEntry("hpt_eff_2","|y|: 0-0.6, 0-100%","lep");
  //legend->AddEntry("hpt_eff_3","|y|: 0.6-1.2, 0-100%","lep");
  //legend->AddEntry("hpt_eff_4","|y|: 1.2-1.8, 0-100%","lep");
  //legend->AddEntry("hpt_eff_5","|y|: 1.8-2.4, 0-100%","lep");
  //legend->SetBorderSize( 0);
  legend->AddEntry("hpt_eff_1","0-90%","lep");
  legend->AddEntry("hpt_eff_2","0-10%","lep");
  legend->AddEntry("hpt_eff_3","10-30%","lep");
  legend->AddEntry("hpt_eff_4","30-60%","lep");
  legend->AddEntry("hpt_eff_5","60-90%","lep");
  legend->SetBorderSize(0);
  ...
  hpt_eff_1->SetName(Form("mc_eff_vs_pt_TnP%d_1 ",isTnP));
  hpt_eff_2->SetName(Form("mc_eff_vs_pt_TnP%d_2  ",isTnP));
  hpt_eff_3->SetName(Form("mc_eff_vs_pt_TnP%d_3 ",isTnP));
  hpt_eff_4->SetName(Form("mc_eff_vs_pt_TnP%d_4",isTnP));
  hpt_eff_5->SetName(Form("mc_eff_vs_pt_TnP%d_5",isTnP));
  hpt_eff_NoTrig_1->SetName(Form("mc_eff_vs_pt_TnP%d_1_NoTrig",isTnP));
  hpt_eff_NoTrig_2->SetName(Form("mc_eff_vs_pt_TnP%d_2_NoTrig",isTnP));
  hpt_eff_NoTrig_3->SetName(Form("mc_eff_vs_pt_TnP%d_3_NoTrig",isTnP));
  hpt_eff_NoTrig_4->SetName(Form("mc_eff_vs_pt_TnP%d_4_NoTrig",isTnP));
  hpt_eff_NoTrig_5->SetName(Form("mc_eff_vs_pt_TnP%d_5_NoTrig",isTnP));
  hpt_eff_Trig_1->SetName(Form("mc_eff_vs_pt_TnP%d_1_Trig",isTnP));
  hpt_eff_Trig_2->SetName(Form("mc_eff_vs_pt_TnP%d_2_Trig",isTnP));
  hpt_eff_Trig_3->SetName(Form("mc_eff_vs_pt_TnP%d_3_Trig",isTnP));
  hpt_eff_Trig_4->SetName(Form("mc_eff_vs_pt_TnP%d_4_Trig",isTnP));
  hpt_eff_Trig_5->SetName(Form("mc_eff_vs_pt_TnP%d_5_Trig",isTnP));
  hpt_eff_reco_1->SetName(Form("mc_eff_vs_pt_1_Trig"));
  hpt_eff_reco_2->SetName(Form("mc_eff_vs_pt_2_Trig"));
  hpt_eff_reco_3->SetName(Form("mc_eff_vs_pt_3_Trig"));
  hpt_eff_reco_4->SetName(Form("mc_eff_vs_pt_4_Trig"));
  hpt_eff_reco_5->SetName(Form("mc_eff_vs_pt_5_Trig"));
  ...
  hpt_eff_reco_1->Write();
  hpt_eff_reco_2->Write();
  hpt_eff_reco_3->Write();
  hpt_eff_reco_4->Write();
  hpt_eff_reco_5->Write();
  hpt_reco_NoTrig_1->Write();
  hy_eff->Write();
  cpt_eff->Write();
  cy_eff->Write();
  hpt_reco_1->Write();
