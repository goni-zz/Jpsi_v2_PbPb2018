...
void v2mass_hist_weight_TnPSysUp_210928(
    ...
    ) //PR 0: PR, 1: NP, 2: Inc.
{
  ...
  gSystem->mkdir(Form("figs/TnPSysUp_210928/v2mass_hist/%s",DATE.Data()), kTRUE);
  ...
  gSystem->mkdir(Form("roots/TnPSysUp_210928/v2mass_hist/%s",DATE.Data()), kTRUE);
  ...
  TH1D* hEffPt[4];
  hEffPt[0] = (TH1D*) fEff -> Get(Form("hEff_sysUp_mc_eff_vs_pt_TnP%d_PtW%d_cent_20_to_120_absy0_1p2",isTnP,isPtW));
  hEffPt[1] = (TH1D*) fEff -> Get(Form("hEff_sysUp_mc_eff_vs_pt_TnP%d_PtW%d_cent_20_to_120_absy1p2_1p6",isTnP,isPtW));
  hEffPt[2] = (TH1D*) fEff -> Get(Form("hEff_sysUp_mc_eff_vs_pt_TnP%d_PtW%d_cent_20_to_120_absy1p6_1p8",isTnP,isPtW));
  hEffPt[3] = (TH1D*) fEff -> Get(Form("hEff_sysUp_mc_eff_vs_pt_TnP%d_PtW%d_cent_20_to_120_absy1p8_2p4",isTnP,isPtW));
  ...
  if(ctauCut==0) c_mass_v2->SaveAs(Form("figs/TnPSysUp_210928/v2mass_hist/%s/v2Mass_%s_ctau_%.5f_%.5f_%s.pdf",DATE.Data(),kineLabel.Data(),ctauLo,ctauHi,cutName.Data()));
  else if(ctauCut==-1)c_mass_v2->SaveAs(Form("figs/TnPSysUp_210928/v2mass_hist/%s/v2Mass_%s_ctau_%.5f_%s.pdf",DATE.Data(),kineLabel.Data(),ctauLo,cutName.Data()));
  else if(ctauCut== 1)c_mass_v2->SaveAs(Form("figs/TnPSysUp_210928/v2mass_hist/%s/v2Mass_%s_ctau_%.5f_%s.pdf",DATE.Data(),kineLabel.Data(),ctauHi,cutName.Data()));
  else c_mass_v2->SaveAs(Form("figs/TnPSysUp_210928/v2mass_hist/%s/v2Mass_%s_Inc.pdf",DATE.Data(),kineLabel.Data()));
  ...
  TFile *wf; 
  if(ctauCut==0) wf = new TFile(Form("roots/TnPSysUp_210928/v2mass_hist/%s/Jpsi_%s_Eff%d_Acc%d_PtW%d_TnP%d_ctau_%.5f_%.5f_%s.root",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,ctauLo,ctauHi,cutName.Data()),"recreate");
  else if(ctauCut==-1) wf = new TFile(Form("roots/TnPSysUp_210928/v2mass_hist/%s/Jpsi_%s_Eff%d_Acc%d_PtW%d_TnP%d_ctau_%.5f_%s.root",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,ctauLo,cutName.Data()),"recreate");
  else if(ctauCut==1) wf = new TFile(Form("roots/TnPSysUp_210928/v2mass_hist/%s/Jpsi_%s_Eff%d_Acc%d_PtW%d_TnP%d_ctau_%.5f_%s.root",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,ctauHi,cutName.Data()),"recreate");
  else wf = new TFile(Form("roots/TnPSysUp_210928/v2mass_hist/%s/Jpsi_%s_Eff%d_Acc%d_PtW%d_TnP%d_Inc.root",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP),"recreate");
  wf->cd();
  h_v2_final->Write();
  h_decayL->Write();
  g_mass->Write();
