...
void v2mass_hist_weight_AccSys_211013(
    ...
    ) //PR 0: PR, 1: NP, 2: Inc.
{
  ...
  gSystem->mkdir(Form("figs/AccSys_211013/v2mass_hist/%s",DATE.Data()), kTRUE);
  gSystem->mkdir(Form("figs/AccSys_211013/q_vector/%s",DATE.Data()), kTRUE);
  gSystem->mkdir(Form("figs/AccSys_211013/mass_dist/%s",DATE.Data()), kTRUE);
  gSystem->mkdir(Form("figs/AccSys_211013/decayL/%s",DATE.Data()), kTRUE);
  gSystem->mkdir(Form("roots/AccSys_211013/v2mass_hist/%s",DATE.Data()), kTRUE);
  ...
  pad1->Draw();
  pad2->Draw();
  //gSystem->mkdir(Form("figs/AccSys_211013/q_vector",sample.Data()),1);
  if(ctauCut==0) c_mass_v2->SaveAs(Form("figs/AccSys_211013/v2mass_hist/%s/v2Mass_%s_ctau_%.5f_%.5f_%s.pdf",DATE.Data(),kineLabel.Data(),ctauLo,ctauHi,cutName.Data()));
  else if(ctauCut==-1)c_mass_v2->SaveAs(Form("figs/AccSys_211013/v2mass_hist/%s/v2Mass_%s_ctau_%.5f_%s.pdf",DATE.Data(),kineLabel.Data(),ctauLo,cutName.Data()));
  else if(ctauCut== 1)c_mass_v2->SaveAs(Form("figs/AccSys_211013/v2mass_hist/%s/v2Mass_%s_ctau_%.5f_%s.pdf",DATE.Data(),kineLabel.Data(),ctauHi,cutName.Data()));
  else c_mass_v2->SaveAs(Form("figs/AccSys_211013/v2mass_hist/%s/v2Mass_%s_Inc.pdf",DATE.Data(),kineLabel.Data()));
  ...
  //lcut->Draw("same");
  c_decayL->Update();
  if(ctauCut==0) c_decayL->SaveAs(Form("figs/AccSys_211013/decayL/%s/decayL_%s_ctau_%.5f_%.5f_%s.pdf",DATE.Data(),kineLabel.Data(),ctauLo,ctauHi,cutName.Data()));
  else if(ctauCut==-1)c_decayL->SaveAs(Form("figs/AccSys_211013/decayL/%s/decayL_%s_ctau_%.5f_%s.pdf",DATE.Data(),kineLabel.Data(),ctauLo,cutName.Data()));
  else if(ctauCut== 1)c_decayL->SaveAs(Form("figs/AccSys_211013/decayL/%s/decayL_%s_ctau_%.5f_%s.pdf",DATE.Data(),kineLabel.Data(),ctauHi,cutName.Data()));
  else c_decayL->SaveAs(Form("figs/AccSys_211013/decayL/%s/decayL_%s_Inc.pdf",DATE.Data(),kineLabel.Data()));
  ...
  c_mass->Update();
  if(ctauCut==0)c_mass->SaveAs(Form("figs/AccSys_211013/mass_dist/%s/MassDist_%s_ctau_%.5f_%.5f_%s.pdf",DATE.Data(),kineLabel.Data(),ctauLo,ctauHi,cutName.Data()));
  else if(ctauCut==-1)c_mass->SaveAs(Form("figs/AccSys_211013/mass_dist/%s/MassDist_%s_ctau_%.5f_%s.pdf",DATE.Data(),kineLabel.Data(),ctauLo,cutName.Data()));
  else if(ctauCut==1)c_mass->SaveAs(Form("figs/AccSys_211013/mass_dist/%s/MassDist_%s_ctau_%.5f_%s.pdf",DATE.Data(),kineLabel.Data(),ctauHi,cutName.Data()));
  else c_mass->SaveAs(Form("figs/AccSys_211013/mass_dist/%s/MassDist_%s_Inc.pdf",DATE.Data(),kineLabel.Data()));
  ...
  if(ctauCut==0) c_qq_1->SaveAs(Form("figs/AccSys_211013/q_vector/%s/c_qqa_%s_Eff%d_Acc%d_PtW%d_TnP%d_ctau_%.5f_%.5f_%s.pdf",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,ctauLo,ctauHi,cutName.Data()));
  else if(ctauCut==-1)c_qq_1->SaveAs(Form("figs/AccSys_211013/q_vector/%s/c_qqa_%s_Eff%d_Acc%d_PtW%d_TnP%d_ctau_%.5f_%s.pdf",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,ctauLo,cutName.Data()));
  else if(ctauCut==1)c_qq_1->SaveAs(Form("figs/AccSys_211013/q_vector/%s/c_qqa_%s_Eff%d_Acc%d_PtW%d_TnP%d_ctau_%.5f_%s.pdf",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,ctauHi,cutName.Data()));
  else c_qq_1->SaveAs(Form("figs/AccSys_211013/q_vector/%s/c_qqa_%s_Eff%d_Acc%d_PtW%d_TnP%d_Inc.pdf",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP));
  ...
  leg_v2_2->Draw("same");
  if(ctauCut==0) c_qq_2->SaveAs(Form("figs/AccSys_211013/q_vector/%s/c_qaqb_%s_Eff%d_Acc%d_PtW%d_TnP%d_ctau_%.5f_%.5f_%s.pdf",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,ctauLo,ctauHi,cutName.Data()));
  else if(ctauCut==-1)c_qq_2->SaveAs(Form("figs/AccSys_211013/q_vector/%s/c_qaqb_%s_Eff%d_Acc%d_PtW%d_TnP%d_ctau_%.5f_%s.pdf",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,ctauLo,cutName.Data()));
  else if(ctauCut==1)c_qq_2->SaveAs(Form("figs/AccSys_211013/q_vector/%s/c_qaqb_%s_Eff%d_Acc%d_PtW%d_TnP%d_ctau_%.5f_%s.pdf",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,ctauHi,cutName.Data()));
  else c_qq_2->SaveAs(Form("figs/AccSys_211013/q_vector/%s/c_qaqb_%s_Eff%d_Acc%d_PtW%d_TnP%d_Inc.pdf",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP));
  ...
  leg_v2_3->Draw("same");
  if(ctauCut==0) c_qq_3->SaveAs(Form("figs/AccSys_211013/q_vector/%s/c_qaqc_%s_Eff%d_Acc%d_PtW%d_TnP%d_ctau_%.5f_%.5f_%s.pdf",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,ctauLo,ctauHi,cutName.Data()));
  else if(ctauCut==-1)c_qq_3->SaveAs(Form("figs/AccSys_211013/q_vector/%s/c_qaqc_%s_Eff%d_Acc%d_PtW%d_TnP%d_ctau_%.5f_%s.pdf",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,ctauLo,cutName.Data()));
  else if(ctauCut== 1)c_qq_3->SaveAs(Form("figs/AccSys_211013/q_vector/%s/c_qaqc_%s_Eff%d_Acc%d_PtW%d_TnP%d_ctau_%.5f_%s.pdf",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,ctauHi,cutName.Data()));
  else c_qq_3->SaveAs(Form("figs/AccSys_211013/q_vector/%s/c_qaqc_%s_Eff%d_Acc%d_PtW%d_TnP%d_Inc.pdf",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP));
  ...
  leg_v2_4->Draw("same");
  if(ctauCut==0) c_qq_4->SaveAs(Form("figs/AccSys_211013/q_vector/%s/c_qbqc_%s_Eff%d_Acc%d_PtW%d_TnP%d_ctau_%.5f_%.5f_%s.pdf",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,ctauLo,ctauHi,cutName.Data()));
  else if(ctauCut==-1)c_qq_4->SaveAs(Form("figs/AccSys_211013/q_vector/%s/c_qbqc_%s_Eff%d_Acc%d_PtW%d_TnP%d_ctau_%.5f_%s.pdf",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,ctauLo,cutName.Data()));
  else if(ctauCut==1)c_qq_4->SaveAs(Form("figs/AccSys_211013/q_vector/%s/c_qbqc_%s_Eff%d_Acc%d_PtW%d_TnP%d_ctau_%.5f_%s.pdf",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,ctauHi,cutName.Data()));
  else c_qq_4->SaveAs(Form("figs/AccSys_211013/q_vector/%s/c_qbqc_%s_Eff%d_Acc%d_PtW%d_TnP%d_Inc.pdf",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP));

  TFile *wf; 
  if(ctauCut==0) wf = new TFile(Form("roots/AccSys_211013/v2mass_hist/%s/Jpsi_%s_Eff%d_Acc%d_PtW%d_TnP%d_ctau_%.5f_%.5f_%s.root",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,ctauLo,ctauHi,cutName.Data()),"recreate");
  else if(ctauCut==-1) wf = new TFile(Form("roots/AccSys_211013/v2mass_hist/%s/Jpsi_%s_Eff%d_Acc%d_PtW%d_TnP%d_ctau_%.5f_%s.root",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,ctauLo,cutName.Data()),"recreate");
  else if(ctauCut==1) wf = new TFile(Form("roots/AccSys_211013/v2mass_hist/%s/Jpsi_%s_Eff%d_Acc%d_PtW%d_TnP%d_ctau_%.5f_%s.root",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP,ctauHi,cutName.Data()),"recreate");
  else wf = new TFile(Form("roots/AccSys_211013/v2mass_hist/%s/Jpsi_%s_Eff%d_Acc%d_PtW%d_TnP%d_Inc.root",DATE.Data(),kineLabel.Data(),fEffW,fAccW,isPtW,isTnP),"recreate");
  wf->cd();
  h_v2_final->Write();
  h_decayL->Write();
  g_mass->Write();
